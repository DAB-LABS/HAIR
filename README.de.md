<p align="center">
  <img src="https://raw.githubusercontent.com/DAB-LABS/HAIR/main/images/HAIR-readme-hero-v0.2.png" alt="HAIR-Banner" width="900" />
</p>
...
- **Übernimm ihn.** Hole Codes, die bereits in einem Hersteller-Blaster angelernt sind (etwa Tuya Local), ohne einen einzigen Code am Empfänger neu anzulernen.
...
*Übersetzt aus dem englischen README, Stand v0.14.0. Diese Datei wurde von einem Programmier-Assistenten entworfen und wird mit jeder Version aufgefrischt. Muttersprachler sind herzlich eingeladen, sie zu übernehmen; siehe [Adding a language](CONTRIBUTING.md#adding-a-language).*
