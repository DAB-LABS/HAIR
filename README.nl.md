...
*Vertaald uit de Engelse README, stand v0.14.0. Dit bestand is opgesteld door een programmeerassistent en wordt bij elke release ververst. Moedertaalsprekers zijn welkom om het over te nemen; zie [Adding a language](CONTRIBUTING.md#adding-a-language).*
