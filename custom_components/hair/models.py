...
class EntityConfig:
    ...
    #: When set (e.g. "customac:fujitsu"), climate.py encodes every send
    #: live via CustomAcSource instead of looking up a stored command in
    #: command_mapping. Opt-in feature -- see custom_ac_source.py.
    ac_protocol_id: str | None = None
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "ac_protocol_id": self.ac_protocol_id,
        }
    ...
    def from_dict(cls, data: dict[str, Any]) -> EntityConfig:
        return cls(
            ...
            ac_protocol_id=data.get("ac_protocol_id"),
        )
...
class IRDevice:
    ...
    def clone(self, new_name: str) -> IRDevice:
        ...
        cloned_entity_config = EntityConfig(
            ...
            ac_protocol_id=self.entity_config.ac_protocol_id,
        )
        return IRDevice(
            name=new_name,
