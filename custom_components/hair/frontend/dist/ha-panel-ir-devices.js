...
`;let Yi=class extends ne{constructor(){super(...arguments),this.triggers=[],this.receivers=[],this.top=0,this.left=0}render(){return B`
        ...
        `}_renderScope(e){const t=e.receiver_entity_ids??[];return 0===t.length?"Any receiver":1===t.length?this._friendly(t[0]):`${this._friendly(t[0])} + ${t.length-1} more`}_friendly(e){const t=this.receivers.find(t=>t.entity_id===e);return t?.name??e}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}};Yi.styles=[Zi,r`
            :host {
                display: contents;
            }
    ...
    `],e([he({attribute:!1})],ds.prototype,"api",void 0),e([he({attribute:!1})],ds.prototype,"hass",void 0),e([he({attribute:!1})],ds.prototype,"value",void 0),e([he({type:Boolean})],ds.prototype,"busy",void 0),e([pe()],ds.prototype,"_local",void 0),ds=e([ue("ir-test-emitter-dialog")],ds);let cs=class extends ne{constructor(){super(...arguments),this.assignments=[],this.top=0,this.left=0}render(){return B`
            ...
            >
                ...
                ${this.assignments.map(e=>B`
                        <button
                            class="popover-item"
                            title="Open ${e.device_name} in Devices"
