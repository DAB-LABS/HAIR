        ...
        `}_renderRow(e){return B`
            ...
            >
                ...
                ${e.wig?.fitting?.state?B`<span
                          ...
                          >&check;</span
                      >`:""}
                ${e.wig?.linked_devices?.length?B`<span
                          class="linked-chip"
                          @click=${i=>this._toggleLinkedPopover(e.id,i)}
                          >${$e("wigs.linked",e.wig.linked_devices.length)}</span
                      >`:""}
