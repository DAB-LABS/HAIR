        ...
        `],e([pe({attribute:!1})],Ha.prototype,"api",void 0),e([pe({attribute:!1})],Ha.prototype,"hass",void 0),e([ge()],Ha.prototype,"_device",void 0),e([ge()],Ha.prototype,"_loading",void 0),e([ge()],Ha.prototype,"_error",void 0),e([ge()],Ha.prototype,"_triggers",void 0),e([ge()],Ha.prototype,"_receivers",void 0),e([ge()],Ha.prototype,"_hasReceivers",void 0),e([ge()],Ha.prototype,"_filter",void 0),e([ge()],Ha.prototype,"_search",void 0),e([ge()],Ha.prototype,"_bloomIds",void 0),e([ge()],Ha.prototype,"_assignSignal",void 0),e([ge()],Ha.prototype,"_assignedPopover",void 0),e([ge()],Ha.prototype,"_triggerDialog",void 0),e([ge()],Ha.prototype,"_triggerEditDialog",void 0),e([ge()],Ha.prototype,"_triggerPopover",void 0),e([ge()],Ha.prototype,"_confirmDeleteTriggerId",void 0),e([ge()],Ha.prototype,"_deleteSignal",void 0),e([ge()],Ha.prototype,"_editSignal",void 0),e([ge()],Ha.prototype,"_testDialog",void 0),e([ge()],Ha.prototype,"_testEmitters",void 0),e([ge()],Ha.prototype,"_testingSignalId",void 0),e([ge()],Ha.prototype,"_testResult",void 0),Ha=e([ue("ir-mirror")],Ha);let Na=class extends se{constructor(){super(...arguments),this._fit=null,this._order=[],this._verdicts=new Map,this._facts=new Map,this._emitter="",this._receiverIds=new Set,this._view="session",this._confirmDiscard=!1,this._busy=!1,this._error=null,this._handle="",this._github="",this._note=""}connectedCallback(){super.connectedCallback(),this._load()}async _load(){try{const[e,i]=await Promise.all([this.api.fittingState(this.wig.filename),this.api.listReceivers().catch(()=>[])]);this._receiverIds=new Set(i.map(e=>e.entity_id)),this._fit=e,this._handle=e.username;const t=e.ledger.find(i=>i.github&&i.handle.toLowerCase()===e.username.toLowerCase());this._github=t?.github??"";const a=new Map;e.signals.forEach((i,t)=>{e.draft?.failed.includes(i)?a.set(t,"failed"):e.draft?.confirmed.includes(i)&&a.set(t,"worked")}),this._verdicts=a;const r=e.signals.map((e,i)=>i);this._order=[...r.filter(e=>!a.has(e)),...r.filter(e=>a.has(e))];const o=this._emitters();1===o.length&&(this._emitter=o[0].id)}catch(e){this._error=e?.message??String(e)}}_emitters(){const e=this.hass?.states??{},i=[];for(const[t,a]of Object.entries(e))!t.startsWith("infrared.")||this._receiverIds.has(t)||a.attributes?.hair_observer||i.push({id:t,name:a.attributes?.friendly_name??t});return i}_close(){this.dispatchEvent(new CustomEvent("closed",{bubbles:!0,composed:!0}))}async _send(e){if(!this._emitter||!this._fit)return;const i=this._facts.get(e)??{sent:0,heard:!1,busy:!1};if(!i.busy){this._facts=new Map(this._facts).set(e,{...i,busy:!0});try{const t=await this.api.fittingSend(this.wig.filename,e,this._emitter);this._facts=new Map(this._facts).set(e,{sent:i.sent+1,heard:i.heard||t.heard,busy:!1})}catch(t){this._facts=new Map(this._facts).set(e,{...i,busy:!1}),this._error=t?.message??String(t)}}}async _mark(e,i){const t=this._verdicts.get(e)===i?"untested":i,a=new Map(this._verdicts);"untested"===t?a.delete(e):a.set(e,t),this._verdicts=a;try{await this.api.fittingMark(this.wig.filename,e,t)}catch(e){this._error=e?.message??String(e)}}async _discard(){this._busy=!0;try{await this.api.fittingDiscard(this.wig.filename)}catch{}this._busy=!1,this._recordedRefresh(),this._close()}async _record(){this._busy=!0,this._error=null;try{const e=await this.api.fittingFinish(this.wig.filename,{...this._handle.trim()?{handle:this._handle.trim()}:{},...this._github.trim()?{github:this._github.trim()}:{},...this._note.trim()?{note:this._note.trim()}:{}});this.dispatchEvent(new CustomEvent("recorded",{detail:e,bubbles:!0,composed:!0})),this._close()}catch(e){this._error=e?.message??String(e)}this._busy=!1}_recordedRefresh(){this.dispatchEvent(new CustomEvent("recorded",{detail:null,bubbles:!0,composed:!0}))}get _counts(){let e=0,i=0;for(const t of this._verdicts.values())"worked"===t?e+=1:i+=1;const t=this._fit?.signals.length??0;return{worked:e,failed:i,tested:e+i,total:t,perfect:t>0&&e===t}}render(){return B`
            <div class="overlay" @click=${this._close}>
                <div
                    ...
                    @click=${e=>e.stopPropagation()}
                >
                    ${"sign"===this._view?this._renderSign():this._renderSession()}
                </div>
            </div>
        ...
        `}_renderRow(e){return B`
            ...
            >
                ...
                ${e.wig?.fitting?.state?B`<span
                          class="fit-tick ${e.wig.fitting.state}"
