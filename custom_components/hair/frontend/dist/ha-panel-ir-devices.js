...
`;let Vt=class extends se{constructor(){super(...arguments),this.color="green",this.count=0}render(){if(this.count<1)return B``;const e=this.count>=10;return B`<span
    ...
    `,e([pe({type:String})],Vt.prototype,"color",void 0),e([pe({type:Number})],Vt.prototype,"count",void 0),Vt=e([ue("ir-count-dot")],Vt);let qt=class extends se{constructor(){super(...arguments),this.templateName="",this.command=null,this.busy=!1,this.actionLabel=null,this.hasTrigger=!1,this.triggerCount=0,this.showActionMapping=!0,this._editingName=!1,this._draftName=""}_commandLabel(){const e=this.command;return e.protocol&&e.code?`${e.protocol}: ${e.code}`:e.raw_timings?.length?ke("cmdrow.raw_timings",{count:e.raw_timings.length}):e.protocol??"IR"}_prontoSlArray(e){const i=e.trim().split(/\s+/);if(i.length<6)return null;const t=parseInt(i[2],16)+parseInt(i[3],16),a=i.slice(4);if(a.length<2*t)return null;const o=[];for(let e=0;e<2*t;e++){const i=parseInt(a[e],16);o.push(i>=48)}return o.length>0?o:null}_renderDiamonds(){const e=this.command;if(!e||"PRONTO"!==e.protocol?.toUpperCase()||!e.code)return null;const i=this._prontoSlArray(e.code);return i?B`<span class="diamonds">${i.map(e=>e?B`<span class="diamond long">◆</span>`:B`<span class="diamond short">◇</span>`)}</span>`:null}_emit(e,i){const t=i?.currentTarget?.getBoundingClientRect()??null;this.dispatchEvent(new CustomEvent(e,{detail:{templateName:this.templateName,command:this.command,buttonRect:t},bubbles:!0,composed:!0}))}_startRename(e){this.command&&!this.busy&&(e.stopPropagation(),this._draftName=this.command.name,this._editingName=!0,this.updateComplete.then(()=>{const e=this.shadowRoot?.querySelector(".name-input");e?.focus(),e?.select()}))}_commitRename(){if(!this._editingName)return;const e=this._draftName.trim();this._editingName=!1,this.command&&e&&e!==this.command.name&&this.dispatchEvent(new CustomEvent("rename-command",{detail:{command:this.command,name:e},bubbles:!0,composed:!0}))}_onRenameKeydown(e){"Enter"===e.key?(e.preventDefault(),this._commitRename()):"Escape"===e.key&&(this._editingName=!1)}render(){const e=null!==this.command,i=e?this._renderDiamonds():null;return B`
                    ...
                    <div class="name">
                        ${e?this._editingName?B`<input
                                  ...
                                  />`:B`<span
                                      ...
                                      ></span
                                  >`:B`${this.templateName}`}
                        ${e&&"matrix"===this.command?.source?B`<span class="state-chip"
    ...
    `,e([pe({attribute:!1})],Ot.prototype,"api",void 0),e([pe({attribute:!1})],Ot.prototype,"hass",void 0),e([pe({attribute:!1})],Ot.prototype,"device",void 0),e([pe({attribute:!1})],Ot.prototype,"commandName",void 0),e([pe({attribute:!1})],Ot.prototype,"timeout",void 0),e([ge()],Ot.prototype,"_phase",void 0),e([ge()],Ot.prototype,"_result",void 0),e([ge()],Ot.prototype,"_duplicate",void 0),e([ge()],Ot.prototype,"_error",void 0),e([ge()],Ot.prototype,"_timeRemaining",void 0),e([ge()],Ot.prototype,"_sessionId",void 0),Ot=e([ue("ir-capture-dialog")],Ot);const Bt=n`
...
`;let Ft=class extends se{constructor(){super(...arguments),this.title="",this.message="",this.confirmLabel="",this.cancelLabel="",this.destructive=!1,this._busy=!1}_close(){this.dispatchEvent(new CustomEvent("closed",{bubbles:!0,composed:!0}))}_confirm(){this.dispatchEvent(new CustomEvent("confirmed",{bubbles:!0,composed:!0}))}render(){return B`
    ...
    `],e([pe()],Ft.prototype,"title",void 0),e([pe()],Ft.prototype,"message",void 0),e([pe()],Ft.prototype,"confirmLabel",void 0),e([pe()],Ft.prototype,"cancelLabel",void 0),e([pe({type:Boolean})],Ft.prototype,"destructive",void 0),e([ge()],Ft.prototype,"_busy",void 0),Ft=e([ue("ir-confirm-dialog")],Ft);let Ut=class extends se{constructor(){super(...arguments),this.source="catalog",this.sourceId="",this.sourceName="",this._brand="",this._model="",this._notes="",this._fccId="",this._upc="",this._asin="",this._oem="",this._busy=!1,this._error=null,this._done=null}_close(){this.dispatchEvent(new CustomEvent("closed",{bubbles:!0,composed:!0}))}async _save(){this._busy=!0,this._error=null;try{const e={};this._brand.trim()&&(e.brand=this._brand.trim()),this._model.trim()&&(e.model=this._model.trim()),this._notes.trim()&&(e.notes=this._notes.trim()),this._fccId.trim()&&(e.fcc_id=this._fccId.trim()),this._upc.trim()&&(e.upc=this._upc.trim()),this._asin.trim()&&(e.asin=this._asin.trim()),this._oem.trim()&&(e.oem=this._oem.trim());const i=await this.api.wigsExport(this.source,this.sourceId,e);this.dispatchEvent(new CustomEvent("wig-saved",{detail:i,bubbles:!0,composed:!0})),this._done=i}catch(e){this._error=e.message}finally{this._busy=!1}}render(){return this._done?B`
                <ha-dialog
                    open
            ...
            >
                ...
                <div class="pair-grid">
                    ...
                    <div class="field">
                        <label>${ke("wigs.editor.fcc_id")}</label>
                        <input
                            type="text"
                            .value=${this._fccId}
                            @input=${e=>this._fccId=e.target.value}
                        />
                    </div>
                    <div class="field">
                        <label>${ke("wigs.editor.upc")}</label>
                        <input
                            type="text"
                            .value=${this._upc}
                            @input=${e=>this._upc=e.target.value}
                        />
                    </div>
                    <div class="field">
                        <label>${ke("wigs.editor.asin")}</label>
                        <input
                            type="text"
                            .value=${this._asin}
                            @input=${e=>this._asin=e.target.value}
                        />
                    </div>
                    <div class="field">
                        <label>${ke("wigs.editor.oem")}</label>
                        <input
                            type="text"
                            .value=${this._oem}
                            @input=${e=>this._oem=e.target.value}
                        />
                    </div>
                </div>
                <div class="ident-hint">${ke("wigs.editor.ids_hint")}</div>
                <div class="field">
        ...
        `],e([pe({attribute:!1})],Ut.prototype,"api",void 0),e([pe()],Ut.prototype,"source",void 0),e([pe()],Ut.prototype,"sourceId",void 0),e([pe()],Ut.prototype,"sourceName",void 0),e([ge()],Ut.prototype,"_brand",void 0),e([ge()],Ut.prototype,"_model",void 0),e([ge()],Ut.prototype,"_notes",void 0),e([ge()],Ut.prototype,"_fccId",void 0),e([ge()],Ut.prototype,"_upc",void 0),e([ge()],Ut.prototype,"_asin",void 0),e([ge()],Ut.prototype,"_oem",void 0),e([ge()],Ut.prototype,"_busy",void 0),e([ge()],Ut.prototype,"_error",void 0),e([ge()],Ut.prototype,"_done",void 0),Ut=e([ue("ir-save-wig-dialog")],Ut);let Wt=class extends se{constructor(){super(...arguments),this.value=[],this.disabled=!1,this.excludeEntityIds=[],this._didAutoSelect=!1,this._receiverIds=new Set,this._receiversLoaded=!1}updated(e){if(super.updated(e),e.has("api")&&this.api&&!this._receiversLoaded&&(this._receiversLoaded=!0,this._loadReceivers()),!this._didAutoSelect)if(this.value.length>0)this._didAutoSelect=!0;else{const e=this._getEmitters();1===e.length&&(this._didAutoSelect=!0,this._fireChange([e[0].entity_id]))}}async _loadReceivers(){if(this.api)try{const e=await this.api.listReceivers();this._receiverIds=new Set(e.map(e=>e.entity_id))}catch{this._receiverIds=new Set}}_getEmitters(){const e=this.hass?.states??{},i=new Set(this.excludeEntityIds),t=[];for(const[a,o]of Object.entries(e))!a.startsWith("infrared.")||i.has(a)||this._receiverIds.has(a)||o.attributes.hair_observer||t.push({entity_id:a,name:o.attributes.friendly_name??a});return t}_emitterName(e){const i=this.hass?.states?.[e];return i?.attributes?.friendly_name??e}_onAdd(e){const i=e.target,t=i.value;t&&(i.value="",this.value.includes(t)||this._fireChange([...this.value,t]))}_onRemove(e){this._fireChange(this.value.filter(i=>i!==e))}_fireChange(e){this.value=e,this.dispatchEvent(new CustomEvent("emitters-changed",{detail:{value:e},bubbles:!0,composed:!0}))}render(){const e=this._getEmitters(),i=e.filter(e=>!this.value.includes(e.entity_id));return B`
    ...
    `,e([pe({attribute:!1})],Wt.prototype,"hass",void 0),e([pe({attribute:!1})],Wt.prototype,"api",void 0),e([pe({attribute:!1})],Wt.prototype,"value",void 0),e([pe({type:Boolean})],Wt.prototype,"disabled",void 0),e([pe({attribute:!1})],Wt.prototype,"excludeEntityIds",void 0),e([ge()],Wt.prototype,"_didAutoSelect",void 0),e([ge()],Wt.prototype,"_receiverIds",void 0),Wt=e([ue("ir-emitter-picker")],Wt);const Gt=[3e4,33e3,36e3,38e3,4e4,56e3],Zt=e=>Gt.reduce((i,t)=>Math.abs(t-e)<Math.abs(i-e)?t:i);let Kt=class extends se{constructor(){super(...arguments),this.signalId=null,this.commandId=null,this.initialPronto="",this.initialAlias="",this.initialSendCount=1,this.initialDitto=1,this.initialObservedRepeatCount=0,this.initialTxForceRaw=!1,this.initialDecodedProtocol=null,this.hasTrigger=!1,this.allowSnap=!1,this._pronto="",this._alias="",this._sendCount=1,this._ditto=1,this._busy=!1,this._error=null,this._validation=null,this._copyHint=null,this._snapping=!1,this._snapFlash=!1,this._debounce=null}get _isCommand(){return null!==this.commandId}get _isEdit(){return null!==this.signalId||null!==this.commandId}get _dirty(){return this._pronto!==this.initialPronto||this._alias!==this.initialAlias||this._sendCount!==this.initialSendCount||this._ditto!==this.initialDitto}get _canSave(){return!this._busy&&!0===this._validation?.valid&&(!this._isEdit||this._dirty)}get _dittoCountDisabled(){return this._isCommand?!this.initialDecodedProtocol||!!this.initialTxForceRaw:!this._pronto.trim()||null===this._validation||!this._validation.recognized_protocol}get _dittoDisabledTooltip(){return this._isCommand&&this.initialDecodedProtocol&&this.initialTxForceRaw?ke("editor.ditto_disabled_cmd"):ke("editor.ditto_disabled")}firstUpdated(){this._pronto=this.initialPronto,this._alias=this.initialAlias,this._sendCount=this.initialSendCount,this._ditto=this.initialDitto,this._pronto.trim()&&this._validate()}updated(){const e=this.shadowRoot?.querySelector("textarea");if(!e)return;const i=Math.round(.45*window.innerHeight);e.style.height="0px";const t=Math.min(Math.max(e.scrollHeight+2,64),i);e.style.height=`${t}px`}disconnectedCallback(){super.disconnectedCallback(),null!==this._debounce&&clearTimeout(this._debounce)}_close(){this.dispatchEvent(new CustomEvent("closed",{bubbles:!0,composed:!0}))}_onSendCountInput(e){const i=parseInt(e.target.value,10);this._sendCount=Number.isNaN(i)?1:Math.max(1,Math.min(i,10))}_onDittoInput(e){const i=parseInt(e.target.value,10);this._ditto=Number.isNaN(i)?0:Math.max(0,Math.min(i,20))}_onProntoInput(e){this._pronto=e.target.value,null!==this._debounce&&clearTimeout(this._debounce),this._pronto.trim()?this._debounce=setTimeout(()=>{this._validate()},250):this._validation=null}_onKeydown(e){"Enter"!==e.key||e.shiftKey||(e.preventDefault(),this._canSave&&this._save())}async _validate(){try{this._validation=await this.api.validatePronto(this._pronto)}catch{this._validation=null}}_slPreview(){const e=this._validation?.normalized;if(!e)return null;const i=e.split(" ").map(e=>parseInt(e,16));if(i.length<5||i.some(e=>Number.isNaN(e)))return null;const t=[];for(const e of i.slice(4)){if(e>=1024)break;t.push(e<48?"S":"L")}return t.length?t:null}async _save(){if(!this._canSave)return;this._busy=!0,this._error=null;const e=this._dittoCountDisabled?void 0:this._ditto;try{if(this._isCommand){const i=await this.api.updateCommand({device_id:this.deviceId,command_id:this.commandId,name:this._alias.trim(),pronto:this._pronto,send_count:this._sendCount,repeat_count:e});this.dispatchEvent(new CustomEvent("command-edited",{detail:i,bubbles:!0,composed:!0}))}else if(null!==this.signalId){const i=await this.api.editSignalPronto({device_id:this.deviceId,signal_id:this.signalId,pronto:this._pronto,alias:this._alias.trim(),send_count:this._sendCount,repeat_count:e});this.dispatchEvent(new CustomEvent("signal-edited",{detail:i,bubbles:!0,composed:!0}))}else{const i=await this.api.createSignal({device_id:this.deviceId,pronto:this._pronto,alias:this._alias.trim()||void 0,send_count:this._sendCount,repeat_count:e});this.dispatchEvent(new CustomEvent("signal-created",{detail:i.signal,bubbles:!0,composed:!0}))}}catch(e){this._error=e.message}finally{this._busy=!1}}async _selectCode(){const e=this.shadowRoot?.querySelector("textarea");e&&(e.focus(),e.select());let i=!1;try{window.isSecureContext&&navigator.clipboard&&(await navigator.clipboard.writeText(this._pronto),i=!0)}catch{i=!1}this._copyHint=ke(i?"editor.copied":"editor.press_copy"),setTimeout(()=>{this._copyHint=null},2e3)}_renderFeedback(){const e=this._validation;if(!e)return"";const i=this._slPreview();return B`
        ...
        `}render(){const e=this._isCommand?ke("editor.edit_command"):this._isEdit?ke("editor.edit_signal"):ke("editor.create_signal"),i=this._isEdit?this._busy?ke("common.saving"):ke("common.save"):this._busy?ke("common.creating"):ke("common.create"),t=this._isEdit&&this.hasTrigger&&this._dirty,a=this._isCommand?ke("editor.trigger_note_cmd"):ke("editor.trigger_note_sig"),o=this._isCommand?ke("assign.command_name"):this._isEdit?ke("editor.alias_label"):ke("editor.alias_optional");return B`
            <ha-dialog
                open
                heading=${e}
                scrimClickAction=""
    ...
    `],e([pe({attribute:!1})],Yt.prototype,"api",void 0),e([pe()],Yt.prototype,"signalFingerprint",void 0),e([pe()],Yt.prototype,"protocol",void 0),e([pe()],Yt.prototype,"code",void 0),e([pe()],Yt.prototype,"slPattern",void 0),e([pe()],Yt.prototype,"alias",void 0),e([pe()],Yt.prototype,"byteHash",void 0),e([pe()],Yt.prototype,"decodedFingerprint",void 0),e([pe()],Yt.prototype,"sourceDeviceId",void 0),e([pe()],Yt.prototype,"sourceCommandId",void 0),e([pe({attribute:!1})],Yt.prototype,"trigger",void 0),e([pe({type:Boolean})],Yt.prototype,"mirrorContext",void 0),e([ge()],Yt.prototype,"_name",void 0),e([ge()],Yt.prototype,"_minHits",void 0),e([ge()],Yt.prototype,"_receiverIds",void 0),e([ge()],Yt.prototype,"_busy",void 0),e([ge()],Yt.prototype,"_error",void 0),Yt=e([ue("ir-trigger-dialog")],Yt);const Qt=n`
    .action-popover {
        position: fixed;
        z-index: 50;
        min-width: 200px;
...
`;let Jt=class extends se{constructor(){super(...arguments),this.triggers=[],this.receivers=[],this.top=0,this.left=0}render(){return B`
            <div
        ...
        `}_renderMatrixGrid(e){const i=this._selMode,t=this._branchCells(i,this._selFan,this._selSwing),a=new Map;for(const e of t)void 0!==e.t&&a.set(e.t,e);const o=[...a.keys()].sort((e,i)=>e-i);if(0===o.length){const a=t.find(e=>void 0===e.t)??null;if(!a)return U;const o=null!==e&&this._cellName(a)===e;return B`<div class="mx-grid">
                <button
                    class="mx-tile sel ${o?"cur":""}"
                    @click=${()=>this._select(i,this._selFan,this._selSwing,null)}
                >
                    ${i}
                </button>
            </div>`}const r=this._matrixCells.precision>0?this._matrixCells.precision:1,n=[];for(let e=o[0];e<=o[o.length-1]+r/2;e+=r)n.push(Math.round(100*e)/100);return B`<div class="mx-grid">
            ${n.map(t=>{const o=a.get(t);if(!o)return B`<button
                        class="mx-tile absent"
                        disabled
                        title=${ke("devices.matrix_absent")}
                    >
                        ${this._displayTemp(t)}
                    </button>`;const r=null!==e&&this._cellName(o)===e;return B`<button
                    class="mx-tile ${t===this._selTemp?"sel":""} ${r?"cur":""}"
                    @click=${()=>this._select(i,this._selFan,this._selSwing,t)}
                >
                    ${this._displayTemp(t)}
                </button>`})}
        </div>`}_renderMatrixCard(){const e=this.device.matrix,i=this._climateState()?.attributes?.matrix_cell??null,t=this._matrixCells,a=ea(this.hass),o=a!==e.unit?ke("devices.matrix_native_range",{min:String(e.min_temp),max:String(e.max_temp),unit:e.unit}):"",r=ke("devices.matrix_summary",{cells:String(e.cells),modes:String(e.modes.length),fans:String(e.fan_modes.length),min:ia(e.min_temp,e.unit,a,t?.precision??1),max:ia(e.max_temp,e.unit,a,t?.precision??1),unit:a}),n=this._selectedCell(),s=t&&null!==this._selMode?this._fansFor(this._selMode):[],l=t&&null!==this._selMode?this._swingsFor(this._selMode,this._selFan):[];return B`
            <div class="matrix-card">
                <div class="mx-head">
                    <span class="mx-title">${ke("devices.matrix_title")}</span>
                    <span class="mx-summary" title=${o}>
                        ${r}
                    </span>
                </div>
                ${null!=i?B`<div class="matrix-current">
                          ${ke("devices.matrix_current",{cell:i})}
                      </div>`:U}
                ${t&&null!==this._selMode?B`
                          ${this._renderDimRow(ke("devices.matrix_dim_mode"),t.modes,this._selMode,e=>this._select(e,this._selFan,this._selSwing,this._selTemp))}
                          ${s.length>0?this._renderDimRow(ke("devices.matrix_dim_fan"),s,this._selFan,e=>this._select(this._selMode,e,this._selSwing,this._selTemp)):U}
                          ...
                          <div class="mx-actions">
                              <span class="mx-set">
                                  ${n?ke("devices.matrix_set_state",{name:this._cellName(n)}):U}
                              </span>
                              <button
                                  class="action-btn test-btn"
        ...
        `}render(){const e=this.device.commands,i=e.length;return B`
            ...
            ${this.device.matrix?this._renderMatrixCard():U}
            ...
            <div class="commands-section">
                ...
                <div class="commands-list">
                    ${je(this._commandsListVersion,e.length>0?Ne(e,e=>e.id,e=>B`
                                      <ir-command-row
                                          data-id=${e.id}
                                          .templateName=${e.name}
                                          .command=${e}
                                          ...
                                          .showActionMapping=${"other"!==this.device.device_type&&!this.device.matrix}
    ...
    `],e([pe({attribute:!1})],aa.prototype,"api",void 0),e([pe({attribute:!1})],aa.prototype,"hass",void 0),e([pe({attribute:!1})],aa.prototype,"device",void 0),e([ge()],aa.prototype,"_busy",void 0),e([ge()],aa.prototype,"_captureName",void 0),e([ge()],aa.prototype,"_toast",void 0),e([ge()],aa.prototype,"_confirmDelete",void 0),e([ge()],aa.prototype,"_saveWigOpen",void 0),e([ge()],aa.prototype,"_commandToDelete",void 0),e([ge()],aa.prototype,"_editCommand",void 0),e([ge()],aa.prototype,"_actionOptions",void 0),e([ge()],aa.prototype,"_mappingCommandName",void 0),e([ge()],aa.prototype,"_popoverTop",void 0),e([ge()],aa.prototype,"_popoverLeft",void 0),e([ge()],aa.prototype,"_customActionOpen",void 0),e([ge()],aa.prototype,"_customActionValue",void 0),e([ge()],aa.prototype,"_editingName",void 0),e([ge()],aa.prototype,"_draftName",void 0),e([ge()],aa.prototype,"_matrixCells",void 0),e([ge()],aa.prototype,"_selMode",void 0),e([ge()],aa.prototype,"_selFan",void 0),e([ge()],aa.prototype,"_selSwing",void 0),e([ge()],aa.prototype,"_selTemp",void 0),e([ge()],aa.prototype,"_triggers",void 0),e([ge()],aa.prototype,"_triggerCommand",void 0),e([ge()],aa.prototype,"_triggerEdit",void 0),e([ge()],aa.prototype,"_confirmDeleteTriggerId",void 0),e([ge()],aa.prototype,"_triggerPopover",void 0),e([ge()],aa.prototype,"_receivers",void 0),e([ge()],aa.prototype,"_commandsListVersion",void 0),aa=e([ue("ir-device-detail")],aa);let oa=class extends se{constructor(){super(...arguments),this.sourceId="",this.sourceName="",this._name="",this._busy=!1,this._error=null}connectedCallback(){super.connectedCallback(),this._name=`${this.sourceName} (Copy)`}_close(){this.dispatchEvent(new CustomEvent("closed",{bubbles:!0,composed:!0}))}async _duplicate(){const e=this._name.trim();if(e){this._busy=!0,this._error=null;try{const i=await this.api.duplicateDevice(this.sourceId,e);this.dispatchEvent(new CustomEvent("device-duplicated",{detail:i,bubbles:!0,composed:!0})),this._close()}catch(e){this._error=e.message}finally{this._busy=!1}}else this._error=ke("common.name_required")}_onKeyDown(e){"Enter"===e.key&&(e.preventDefault(),this._duplicate())}render(){return B`
            <ha-dialog
                open
    ...
    `],e([pe({attribute:!1})],oa.prototype,"api",void 0),e([pe({attribute:!1})],oa.prototype,"sourceId",void 0),e([pe({attribute:!1})],oa.prototype,"sourceName",void 0),e([ge()],oa.prototype,"_name",void 0),e([ge()],oa.prototype,"_busy",void 0),e([ge()],oa.prototype,"_error",void 0),oa=e([ue("ir-duplicate-device-dialog")],oa);const ra={media_player:"M21,17H3V5H21M21,3H3A2,2 0 0,0 1,5V17A2,2 0 0,0 3,19H8V21H16V19H21A2,2 0 0,0 23,17V5A2,2 0 0,0 21,3Z",ac:"M11,21H13V11.85L14.6,13.5L16,12.05L12,8L8,12.05L9.4,13.5L11,11.85V21M2,3V11C2,12.66 5.69,14 12,14C18.31,14 22,12.66 22,11V3H2M4,5H20V8.5C18.5,9.27 15.6,10 12,10C8.4,10 5.5,9.27 4,8.5V5Z",fan:"M12,11A1,1 0 0,0 11,12A1,1 0 0,0 12,13A1,1 0 0,0 13,12A1,1 0 0,0 12,11M12.5,2C17,2 17.11,5.57 14.75,6.75C13.76,7.24 13.32,8.29 13.13,9.22C13.61,9.42 14.03,9.73 14.35,10.13C18.05,8.13 22.03,8.92 22.03,12.5C22.03,17 18.46,17.1 17.28,14.73C16.78,13.74 15.72,13.3 14.79,13.11C14.59,13.59 14.28,14 13.88,14.34C15.87,18.03 15.08,22 11.5,22C7,22 6.91,18.42 9.27,17.24C10.25,16.75 10.69,15.71 10.89,14.79C10.4,14.59 9.97,14.27 9.65,13.87C5.96,15.85 2,15.07 2,11.5C2,7 5.56,6.89 6.74,9.26C7.24,10.25 8.29,10.68 9.22,10.87C9.41,10.39 9.73,9.97 10.14,9.65C8.15,5.95 8.94,2 12.5,2Z",light:"M12,2A7,7 0 0,0 5,9C5,11.38 6.19,13.47 8,14.74V17A1,1 0 0,0 9,18H15A1,1 0 0,0 16,17V14.74C17.81,13.47 19,11.38 19,9A7,7 0 0,0 12,2M9,21A1,1 0 0,0 10,22H14A1,1 0 0,0 15,21V20H9V21Z",switch:"M13,3H11V13H13V3M17.83,5.17L16.41,6.59C18,7.35 19,9.05 19,11A7,7 0 0,1 12,18A7,7 0 0,1 5,11C5,9.05 6,7.35 7.58,6.59L6.17,5.17C4.23,6.82 3,9.26 3,12A9,9 0 0,0 12,21A9,9 0 0,0 21,12C21,9.26 19.77,6.82 17.83,5.17Z",screen:"M20,19H4A2,2 0 0,1 2,17V7A2,2 0 0,1 4,5H20A2,2 0 0,1 22,7V17A2,2 0 0,1 20,19M4,7V17H20V7H4M12,10L16,14H13V17H11V14H8L12,10Z",other:"M11,2A2,2 0 0,0 9,4V8H4A2,2 0 0,0 2,10V13A2,2 0 0,0 4,15H5V21A2,2 0 0,0 7,23H17A2,2 0 0,0 19,21V15H20A2,2 0 0,0 22,13V10A2,2 0 0,0 20,8H15V4A2,2 0 0,0 13,2H11Z"},na={media_player:"device_type.media_player",ac:"device_type.ac",fan:"device_type.fan",light:"device_type.light",switch:"device_type.switch",screen:"device_type.screen",other:"device_type.other_card"},sa="M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19M8,9H16V19H8V9M15.5,4L14.5,3H9.5L8.5,4H5V6H19V4H15.5Z";let la=class extends se{constructor(){super(...arguments),this.devices=[],this.loading=!1,this.expandedDeviceId=null,this._emitters=[],this._captureProviders=[],this._pluckBlasters=[],this._expandedDevice=null,this._triggers=[],this._glowTriggerIds=new Set,this._editTrigger=null,this._confirmDeleteTrigger=null,this._duplicateTarget=null,this._confirmDeleteDevice=null,this._devicesVersion=0,this._localDevices=null,this._devicesSortable=null,this._pendingDevicesSave=null,this._unsubTriggerFired=null}connectedCallback(){super.connectedCallback(),this._discoverHardware(),this._loadTriggers(),this._subscribeTriggerFired()}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribeTriggerFired(),this._devicesSortable?.destroy(),this._devicesSortable=null,null!==this._pendingDevicesSave&&clearTimeout(this._pendingDevicesSave)}willUpdate(e){e.has("devices")&&(this._localDevices=null)}updated(e){(e.has("hass")||e.has("api"))&&this._discoverHardware(),e.has("api")&&this.api&&!this._unsubTriggerFired&&(this._loadTriggers(),this._subscribeTriggerFired()),e.has("expandedDeviceId")&&this._loadExpandedDevice(),this._syncDevicesSortable()}_syncDevicesSortable(){const e=this.renderRoot.querySelector(".device-grid");e&&!this._devicesSortable?this._attachDevicesSortable(e):!e&&this._devicesSortable&&(this._devicesSortable.destroy(),this._devicesSortable=null)}_attachDevicesSortable(e){this._devicesSortable=ft.create(e,{draggable:".device-card",filter:".card-action",preventOnFilter:!1,delay:150,delayOnTouchOnly:!0,animation:150,ghostClass:"sortable-ghost",onEnd:()=>{const i=Array.from(e.querySelectorAll(".device-card")).map(e=>e.dataset.id).filter(e=>!!e),t=this._localDevices??this.devices,a=new Map(t.map(e=>[e.id,e])),o=i.map(e=>a.get(e)).filter(e=>!!e);if(o.length===t.length){this._localDevices=o,this._devicesSortable?.destroy(),this._devicesSortable=null;for(const i of Array.from(e.querySelectorAll(".device-card, .expanded-detail")))i.remove();this._devicesVersion++,this._scheduleDevicesSave(o.map(e=>e.id))}}})}_scheduleDevicesSave(e){null!==this._pendingDevicesSave&&clearTimeout(this._pendingDevicesSave),this._pendingDevicesSave=window.setTimeout(async()=>{if(this._pendingDevicesSave=null,this.api)try{await this.api.reorderDevices(e)}catch{this.dispatchEvent(new CustomEvent("device-changed",{bubbles:!0,composed:!0}))}},500)}async _loadExpandedDevice(){if(this.expandedDeviceId&&this.api)try{this._expandedDevice=await this.api.getDevice(this.expandedDeviceId)}catch{this._expandedDevice=null}else this._expandedDevice=null}async _onExpandedDeviceChanged(){await this._loadExpandedDevice(),this.dispatchEvent(new CustomEvent("device-changed",{bubbles:!0,composed:!0}))}_onExpandedDeviceDeleted(){this.dispatchEvent(new CustomEvent("device-deleted",{bubbles:!0,composed:!0}))}_onCommandsReordered(e){if(!this._expandedDevice)return;const i=e.detail?.commands;Array.isArray(i)&&(this._expandedDevice={...this._expandedDevice,commands:i})}_onCollapse(){this.dispatchEvent(new CustomEvent("device-selected",{detail:this.expandedDeviceId,bubbles:!0,composed:!0}))}async _discoverHardware(){const e=new Set;if(this.api)try{const i=await this.api.listReceivers();for(const t of i)e.add(t.entity_id)}catch{}const i=this.hass?.states??{},t=[];for(const[a,o]of Object.entries(i))!a.startsWith("infrared.")||e.has(a)||o.attributes.hair_observer||t.push({entity_id:a,name:o.attributes.friendly_name??a});if(this._emitters=t,this.api)try{this._captureProviders=await this.api.listCaptureProviders()}catch{}if(this.api)try{const{vendors:e}=await this.api.listPluckVendors(),i=[];for(const t of e)for(const e of t.blasters)i.push({integration:t.integration,entity_id:e.entity_id,name:e.name,vendorName:t.name});this._pluckBlasters=i}catch{this._pluckBlasters=[]}}_select(e){this.dispatchEvent(new CustomEvent("device-selected",{detail:e,bubbles:!0,composed:!0}))}_add(){this.dispatchEvent(new CustomEvent("add-device",{bubbles:!0,composed:!0}))}_openInPlucker(e){this.dispatchEvent(new CustomEvent("navigate-plucker",{detail:{vendor_entity_id:e},bubbles:!0,composed:!0}))}_openDuplicateDialog(e,i){i.stopPropagation(),this._duplicateTarget=e}_closeDuplicateDialog(){this._duplicateTarget=null}_onDeviceDuplicated(){this._duplicateTarget=null,this.dispatchEvent(new CustomEvent("device-changed",{bubbles:!0,composed:!0}))}_requestDeleteDevice(e,i){i.stopPropagation(),this._confirmDeleteDevice=e}async _doDeleteDevice(){if(!this._confirmDeleteDevice||!this.api)return;const e=this._confirmDeleteDevice;this._confirmDeleteDevice=null;try{await this.api.deleteDevice(e.id),this.dispatchEvent(new CustomEvent("device-deleted",{bubbles:!0,composed:!0}))}catch{}}_navigateIntegration(e){const i=`/config/integrations/integration/${e}`;window.history.pushState(null,"",i),window.dispatchEvent(new PopStateEvent("popstate"))}async _loadTriggers(){if(this.api)try{this._triggers=await this.api.listTriggers()}catch{}}async _subscribeTriggerFired(){if(this.api)try{this._unsubTriggerFired=await this.api.subscribeTriggerFired(e=>{this._glowTriggerIds=new Set([...this._glowTriggerIds,e.trigger_id]),setTimeout(()=>{const i=new Set(this._glowTriggerIds);i.delete(e.trigger_id),this._glowTriggerIds=i},2500)})}catch{}}async _unsubscribeTriggerFired(){this._unsubTriggerFired&&(await this._unsubTriggerFired(),this._unsubTriggerFired=null)}_openEditTrigger(e,i){i.stopPropagation(),this._editTrigger=e}_closeEditTrigger(){this._editTrigger=null}async _onTriggerUpdated(){this._editTrigger=null,await this._loadTriggers()}async _toggleTriggerEnabled(e,i){i.stopPropagation();try{await this.api.updateTrigger(e.id,{enabled:!e.enabled}),await this._loadTriggers()}catch{}}_requestDeleteTrigger(e,i){i.stopPropagation(),this._confirmDeleteTrigger=e}async _doDeleteTrigger(){if(!this._confirmDeleteTrigger)return;const e=this._confirmDeleteTrigger;this._confirmDeleteTrigger=null;try{await this.api.deleteTrigger(e.id),await this._loadTriggers()}catch{}}_emitterIntegrationDomain(e){const i=this.hass?.entities?.[e];return i?.platform?i.platform:e.split(".")[0]}_getEmitterDeviceIds(){const e=new Set;for(const i of this._emitters){const t=this.hass?.entities?.[i.entity_id];t?.device_id&&e.add(t.device_id)}return e}_getEmitterEntityIdsByDevice(){const e=new Map;for(const i of this._emitters){const t=this.hass?.entities?.[i.entity_id],a=t?.device_id;if(!a)continue;const o=e.get(a)??[];o.push(i.entity_id),e.set(a,o)}return e}_isPre2026_6(){const e=this.hass?.config?.version;if(!e)return!1;const i=e.match(/^(\d+)\.(\d+)/);if(!i)return!1;const t=parseInt(i[1],10),a=parseInt(i[2],10);return t<2026||2026===t&&a<6}_resolveNavType(e,i){if("native"===e.type&&i){const e=this.hass?.entities?.[i]?.platform;return e||"esphome"}return e.type}_classifyHardware(){const e=this._getEmitterEntityIdsByDevice(),i=new Set(e.keys()),t=new Map;for(const a of this._captureProviders){let o,r;if("native"===a.type?(r=a.receiver_entity_id??a.device_id,o=this.hass?.entities?.[r]?.device_id,o||(o=r)):o=a.device_id,!o)continue;const n=t.get(o)??{device_id:o,name:a.name,nav_type:this._resolveNavType(a,r),has_native:!1,has_bridge:!1,has_tx:i.has(o),tx_entity_ids:e.get(o)??[]};"native"===a.type?(n.has_native=!0,n.native_entity_id=r):(n.has_bridge=!0,n.name=a.name,n.nav_type=a.type),t.set(o,n)}const a=Array.from(t.values()),o=a.filter(e=>e.has_tx);return{receivers:a,proxies:o}}_renderRxBadges(e){const i=!e.has_native&&e.has_bridge&&this._isPre2026_6();return B`
            ${e.has_native?B`<span
            ...
            ${i?B`<span
                  ...
                  >RX-NATIVE</span>`:U}
        `}render(){if(this.loading)return B`<div class="loading">${ke("devlist.loading")}</div>`;const e=this._localDevices??this.devices,i=e.length>0,t=this._emitters.length>0,{receivers:a,proxies:o}=this._classifyHardware(),r=a.length>0,n=o.length>0,s=this._triggers.length>0;return i||t||r||n?B`
            <!-- Devices -->
            <div class="toolbar">
            ...
            ${i?B`
                      <div class="grid device-grid">
                          ${je(this._devicesVersion,Ne(e,e=>e.id,e=>B`
                                  <div
                                  ...
                                  >
                                      ...
                                      <div class="card-meta">
                                          ${[e.manufacturer,ke(na[e.device_type])].filter(Boolean).join(" • ")}
                                      </div>
                      ...
                      <div class="grid">
                          ${o.map(e=>B`
                                  ...
                                  >
                                      ...
                                      ${e.tx_entity_ids[0]?B`<div class="card-meta">${e.tx_entity_ids[0]}</div>`:U}
                                      <div class="card-meta">${e.native_entity_id??e.nav_type}</div>
                                      <div class="card-footer">
                                          <span
                                              class="badge tx-native"
    ...
    `,e([pe({attribute:!1})],la.prototype,"devices",void 0),e([pe({attribute:!1})],la.prototype,"hass",void 0),e([pe({attribute:!1})],la.prototype,"api",void 0),e([pe({type:Boolean})],la.prototype,"loading",void 0),e([pe({attribute:!1})],la.prototype,"expandedDeviceId",void 0),e([ge()],la.prototype,"_emitters",void 0),e([ge()],la.prototype,"_captureProviders",void 0),e([ge()],la.prototype,"_pluckBlasters",void 0),e([ge()],la.prototype,"_expandedDevice",void 0),e([ge()],la.prototype,"_triggers",void 0),e([ge()],la.prototype,"_glowTriggerIds",void 0),e([ge()],la.prototype,"_editTrigger",void 0),e([ge()],la.prototype,"_confirmDeleteTrigger",void 0),e([ge()],la.prototype,"_duplicateTarget",void 0),e([ge()],la.prototype,"_confirmDeleteDevice",void 0),e([ge()],la.prototype,"_devicesVersion",void 0),e([ge()],la.prototype,"_localDevices",void 0),la=e([ue("ir-device-list")],la);const da=[{value:"media_player",label:"Media Player"},{value:"ac",label:"Air Conditioner"},{value:"fan",label:"Fan"},{value:"light",label:"Light"},{value:"switch",label:"Switch"},{value:"screen",label:"Screen / Shade"},{value:"other",label:"Other"}];let ca=class extends se{constructor(){super(...arguments),this._name="",this._deviceType="media_player",this._emitterIds=[],this._captureProviders=[],this._busy=!1,this._error=null}connectedCallback(){super.connectedCallback(),this._loadCaptureProviders()}async _loadCaptureProviders(){try{this._captureProviders=await this.api.listCaptureProviders()}catch{}}_close(){this.dispatchEvent(new CustomEvent("closed",{bubbles:!0,composed:!0}))}async _create(){if(this._name.trim())if(0!==this._emitterIds.length){this._busy=!0,this._error=null;try{const e=this._captureProviders[0]??null,i=await this.api.createDevice({name:this._name.trim(),device_type:this._deviceType,emitter_entity_ids:this._emitterIds,capture_device_id:e?.device_id??null,capture_provider_type:e?.type??"esphome"});this.dispatchEvent(new CustomEvent("device-created",{detail:i,bubbles:!0,composed:!0}))}catch(e){this._error=e.message}finally{this._busy=!1}}else this._error=ke("adddev.emitter_required");else this._error=ke("common.name_required")}render(){return B`
            <ha-dialog
                open
    ...
    `],e([pe({attribute:!1})],ca.prototype,"api",void 0),e([pe({attribute:!1})],ca.prototype,"hass",void 0),e([ge()],ca.prototype,"_name",void 0),e([ge()],ca.prototype,"_deviceType",void 0),e([ge()],ca.prototype,"_emitterIds",void 0),e([ge()],ca.prototype,"_captureProviders",void 0),e([ge()],ca.prototype,"_busy",void 0),e([ge()],ca.prototype,"_error",void 0),ca=e([ue("ir-add-device-dialog")],ca);let pa=class extends se{constructor(){super(...arguments),this.deviceId="",this.disabled=!1,this._editing=!1,this._draft=""}updated(e){if(e.has("_editing")&&this._editing){const e=this.shadowRoot?.querySelector(".alias-input");e?.focus(),e?.select()}}_startEdit(e){this.disabled||(e?.stopPropagation(),this._draft=this.signal.alias??"",this._editing=!0)}_onKeydown(e){"Enter"===e.key?this._commit():"Escape"===e.key&&(this._editing=!1)}async _commit(){if(!this._editing)return;const e=this._draft.trim();this._editing=!1,await this._save(e)}async _clear(){this._editing=!1,await this._save("")}async _save(e){try{await this.api.setSignalAlias(this.deviceId,this.signal.id,e),this.dispatchEvent(new CustomEvent("alias-changed",{detail:{id:this.signal.id,alias:e},bubbles:!0,composed:!0}))}catch(e){this.dispatchEvent(new CustomEvent("alias-error",{detail:e.message,bubbles:!0,composed:!0}))}}render(){const e=this.signal;return this._editing?B`
    ...
    `],e([pe({attribute:!1})],ma.prototype,"api",void 0),e([pe({attribute:!1})],ma.prototype,"hass",void 0),e([pe()],ma.prototype,"unknownDeviceId",void 0),e([pe({attribute:!1})],ma.prototype,"signal",void 0),e([pe()],ma.prototype,"suggestedDeviceName",void 0),e([pe()],ma.prototype,"initialMode",void 0),e([ge()],ma.prototype,"_mode",void 0),e([ge()],ma.prototype,"_devices",void 0),e([ge()],ma.prototype,"_selectedDeviceId",void 0),e([ge()],ma.prototype,"_commandName",void 0),e([ge()],ma.prototype,"_newName",void 0),e([ge()],ma.prototype,"_newType",void 0),e([ge()],ma.prototype,"_newEmitterIds",void 0),e([ge()],ma.prototype,"_templates",void 0),e([ge()],ma.prototype,"_customCommand",void 0),e([ge()],ma.prototype,"_sendCount",void 0),e([ge()],ma.prototype,"_dittoCount",void 0),e([ge()],ma.prototype,"_busy",void 0),e([ge()],ma.prototype,"_error",void 0),ma=e([ue("ir-assign-signal-dialog")],ma);const ua=[{value:"media_player",label:"Media Player"},{value:"ac",label:"Air Conditioner"},{value:"fan",label:"Fan"},{value:"light",label:"Light"},{value:"switch",label:"Switch"},{value:"screen",label:"Screen / Shade"},{value:"other",label:"Other"}];let ha=class extends se{constructor(){super(...arguments),this.suggestedName="",this.sourceUnknownId="",this.wigFilename="",this.codebookId="",this.suggestedType="",this.isMatrix=!1,this._name="",this._type="other",this._emitterIds=[],this._busy=!1,this._error=null}connectedCallback(){super.connectedCallback(),this.suggestedName&&!this._name&&(this._name=this.suggestedName),this.suggestedType&&(this._type=this.suggestedType),this.isMatrix&&(this._type="ac")}_close(){this.dispatchEvent(new CustomEvent("closed",{bubbles:!0,composed:!0}))}async _create(){const e=this._name.trim();if(e)if(0!==this._emitterIds.length){this._busy=!0,this._error=null;try{this.wigFilename||this.codebookId?await this.api.wigMakeDevice(this.wigFilename?{filename:this.wigFilename}:{codebookId:this.codebookId},e,this._type,this._emitterIds):await this.api.createDevice({name:e,device_type:this._type,emitter_entity_ids:this._emitterIds,promoted_from_unknown_id:this.sourceUnknownId||null}),this.dispatchEvent(new CustomEvent("device-created",{bubbles:!0,composed:!0}))}catch(e){this._error=e.message}finally{this._busy=!1}}else this._error=ke("promote.emitter_required");else this._error=ke("promote.device_name_required")}render(){return B`
            <ha-dialog
                open
            ...
            >
                ...
                <div class="field">
                    ...
                    ${this.isMatrix?B`<div class="type-hint">
                              ${ke("promote.matrix_type_hint")}
                          </div>`:""}
                </div>
    ...
    `],e([pe({attribute:!1})],ha.prototype,"api",void 0),e([pe({attribute:!1})],ha.prototype,"hass",void 0),e([pe()],ha.prototype,"suggestedName",void 0),e([pe()],ha.prototype,"sourceUnknownId",void 0),e([pe()],ha.prototype,"wigFilename",void 0),e([pe()],ha.prototype,"codebookId",void 0),e([pe()],ha.prototype,"suggestedType",void 0),e([pe({type:Boolean})],ha.prototype,"isMatrix",void 0),e([ge()],ha.prototype,"_name",void 0),e([ge()],ha.prototype,"_type",void 0),e([ge()],ha.prototype,"_emitterIds",void 0),e([ge()],ha.prototype,"_busy",void 0),e([ge()],ha.prototype,"_error",void 0),ha=e([ue("ir-promote-dialog")],ha);let _a=class extends se{constructor(){super(...arguments),this.value=[],this.busy=!1,this._local=[]}connectedCallback(){super.connectedCallback(),this._local=[...this.value]}_close(){this.dispatchEvent(new CustomEvent("closed",{bubbles:!0,composed:!0}))}_send(){0!==this._local.length&&this.dispatchEvent(new CustomEvent("send",{detail:{emitters:[...this._local]},bubbles:!0,composed:!0}))}_onEmittersChanged(e){this._local=e.detail.value,this.dispatchEvent(new CustomEvent("emitters-changed",{detail:{value:this._local},bubbles:!0,composed:!0}))}render(){const e=this._local.length>0&&!this.busy;return B`
            <ha-dialog
                open
    ...
    `],e([pe({attribute:!1})],_a.prototype,"api",void 0),e([pe({attribute:!1})],_a.prototype,"hass",void 0),e([pe({attribute:!1})],_a.prototype,"value",void 0),e([pe({type:Boolean})],_a.prototype,"busy",void 0),e([ge()],_a.prototype,"_local",void 0),_a=e([ue("ir-test-emitter-dialog")],_a);let va=class extends se{constructor(){super(...arguments),this.assignments=[],this.top=0,this.left=0}render(){return B`
            <div
                class="action-popover"
                style="top:${this.top}px; left:${this.left}px"
            >
        ...
        `}_emit(e,i){this.dispatchEvent(new CustomEvent(e,{detail:i,bubbles:!0,composed:!0}))}};va.styles=[Qt,n`
            :host {
                display: contents;
            }
            .chevron {
        ...
        `],e([pe({attribute:!1})],va.prototype,"assignments",void 0),e([pe({type:Number})],va.prototype,"top",void 0),e([pe({type:Number})],va.prototype,"left",void 0),va=e([ue("ir-assigned-popover")],va);const fa="hair-mirror";function ba(e,i){const t=e.decoded_fingerprint??null,a=i.decoded_fingerprint??null;if(null!==t&&null!==a)return t===a;const o=e.byte_hash??null,r=i.byte_hash??null;return null!==o&&null!==r?o===r:e.signal_fingerprint===i.fingerprint}var wa;function ya(e){try{return new Date(e).toLocaleString(ye(),{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return e}}function ka(e){try{const i=Date.now()-new Date(e).getTime();return i<6e4?ke("rel.just_now"):i<36e5?ke("rel.min_ago",{count:Math.floor(i/6e4)}):i<864e5?ke("rel.h_ago",{count:Math.floor(i/36e5)}):ke("rel.d_ago",{count:Math.floor(i/864e5)})}catch{return""}}const xa="M12 9.188c-1.553 0-2.812 1.259-2.812 2.812s1.259 2.812 2.812 2.812c1.553 0 2.812-1.259 2.812-2.812v0c-0.002-1.552-1.26-2.81-2.812-2.812h-0zM12 13.688c-0.932 0-1.688-0.755-1.688-1.688s0.755-1.688 1.688-1.688c0.932 0 1.688 0.755 1.688 1.688v0c-0.002 0.931-0.756 1.686-1.688 1.688h-0zM2.062 12c0.16-2.665 1.25-5.049 2.948-6.856l-0.005 0.006c0.098-0.101 0.159-0.239 0.159-0.392 0-0.31-0.252-0.562-0.562-0.562-0.153 0-0.291 0.061-0.393 0.16l0-0c-1.906 1.998-3.125 4.667-3.27 7.618l-0.001 0.028c0.146 2.979 1.365 5.647 3.275 7.652l-0.005-0.005c0.101 0.098 0.239 0.159 0.392 0.159 0.31 0 0.562-0.252 0.562-0.562 0-0.152-0.061-0.291-0.16-0.392l0 0c-1.694-1.8-2.785-4.185-2.94-6.821l-0.002-0.03zM6.647 12c0.113-1.859 0.874-3.523 2.058-4.784l-0.004 0.004c0.098-0.101 0.159-0.239 0.159-0.392 0-0.31-0.252-0.562-0.562-0.562-0.153 0-0.291 0.061-0.392 0.16l0-0c-1.39 1.457-2.278 3.403-2.383 5.554l-0.001 0.02c0.105 2.171 0.994 4.117 2.386 5.577l-0.003-0.004c0.102 0.104 0.244 0.167 0.4 0.167 0.31 0 0.562-0.251 0.562-0.562 0-0.156-0.064-0.297-0.167-0.399l-0-0c-1.183-1.256-1.944-2.92-2.053-4.759l-0.001-0.021zM19.793 4.355c-0.102-0.101-0.241-0.164-0.396-0.164-0.31 0-0.562 0.252-0.562 0.562 0 0.154 0.062 0.294 0.162 0.395l-0-0c1.691 1.802 2.782 4.185 2.94 6.82l0.002 0.03c-0.16 2.665-1.249 5.05-2.947 6.857l0.005-0.006c-0.105 0.102-0.17 0.244-0.17 0.403 0 0.31 0.252 0.562 0.562 0.562 0.158 0 0.301-0.065 0.404-0.171l0-0c1.906-1.999 3.125-4.667 3.268-7.618l0.001-0.028c-0.146-2.978-1.364-5.647-3.274-7.65l0.005 0.005zM15.299 6.425c-0.102 0.102-0.165 0.242-0.165 0.398 0 0.154 0.062 0.295 0.164 0.397l-0-0c1.181 1.257 1.942 2.92 2.054 4.758l0.001 0.022c-0.114 1.86-0.875 3.523-2.059 4.784l0.004-0.004c-0.101 0.102-0.164 0.241-0.164 0.396 0 0.311 0.252 0.563 0.563 0.563 0.155 0 0.295-0.062 0.397-0.164l-0 0c1.389-1.458 2.277-3.404 2.383-5.555l0.001-0.02c-0.105-2.172-0.994-4.118-2.388-5.578l0.003 0.003c-0.101-0.102-0.242-0.165-0.397-0.165s-0.295 0.063-0.397 0.165l-0 0z",$a="M7,19V17H9V19H7M11,19V17H13V19H11M15,19V17H17V19H15M7,15V13H9V15H7M11,15V13H13V15H11M15,15V13H17V15H15M7,11V9H9V11H7M11,11V9H13V11H11M15,11V9H17V11H15M7,7V5H9V7H7M11,7V5H13V7H11M15,7V5H17V7H15Z";let za=wa=class extends se{constructor(){super(...arguments),this._devices=[],this._hairDevices=[],this._loading=!0,this._saveWigDevice=null,this._deleteRemote=null,this._linkedPopoverId=null,this._linkedPopoverPos={top:0,left:0},this._error=null,this._hasReceivers=!0,this._showDismissed=!1,this._expandedId=null,this._expandedDevice=null,this._flashIds=new Set,this._flashStats=new Set,this._recentSignalIds=[],this._glowSignalIds=new Set,this._hitFlashSignalIds=new Set,this._confirmClearAll=!1,this._triggers=[],this._triggerDialog=null,this._triggerEditDialog=null,this._confirmDeleteTriggerId=null,this._triggerPopover=null,this._assignedPopover=null,this._receivers=[],this._unsubUpdated=null,this._editingDeviceId=null,this._editLabel="",this._promoteTarget=null,this._assignSignal=null,this._deleteSignal=null,this._editSignal=null,this._testingSignalId=null,this._testResult=null,this._testDialog=null,this._testEmitters=[],this._dismissGlowActive=!1,this._dismissDotVisible=!1,this._unsubLive=null,this._unsubRemoved=null,this._unsubDismiss=null,this._dismissGlowTimer=null,this._remotesVersion=0,this._signalsVersion=0,this._remotesSortable=null,this._signalsSortable=null,this._signalsSortableContainer=null,this._pendingRemotesSave=null,this._pendingSignalsSave=null,this._onDocClickForPopover=e=>{const i=e.composedPath(),t=this.shadowRoot?.querySelector("ir-trigger-popover"),a=this.shadowRoot?.querySelector("ir-assigned-popover");t&&i.includes(t)||a&&i.includes(a)||(this._closeTriggerPopover(),this._closeAssignedPopover())},this._onScrollForPopover=()=>{this._closeTriggerPopover(),this._closeAssignedPopover()}}connectedCallback(){super.connectedCallback(),this._load(),this._subscribeLive(),this._subscribeRemoved(),this._subscribeDismissActivity(),this._subscribeUpdated()}updated(e){if(super.updated(e),e.has("_editingDeviceId")&&this._editingDeviceId){const e=this.shadowRoot?.querySelector(".rename-input");e&&(e.focus(),e.select())}this._syncSortables()}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribeLive(),this._unsubscribeRemoved(),this._unsubscribeDismissActivity(),this._unsubscribeUpdated(),this._removePopoverDismiss(),null!==this._dismissGlowTimer&&(clearTimeout(this._dismissGlowTimer),this._dismissGlowTimer=null),this._remotesSortable?.destroy(),this._remotesSortable=null,this._signalsSortable?.destroy(),this._signalsSortable=null,this._signalsSortableContainer=null,null!==this._pendingRemotesSave&&clearTimeout(this._pendingRemotesSave),null!==this._pendingSignalsSave&&clearTimeout(this._pendingSignalsSave)}_syncSortables(){const e=this.renderRoot.querySelector(".device-list");e&&!this._remotesSortable?this._attachRemotesSortable(e):!e&&this._remotesSortable&&(this._remotesSortable.destroy(),this._remotesSortable=null);const i=this.renderRoot.querySelector(".signal-list"),t=!!this._expandedDevice&&!this._expandedDevice.dismissed;!i||!t||this._signalsSortable&&this._signalsSortableContainer===i?i&&t||!this._signalsSortable||(this._signalsSortable.destroy(),this._signalsSortable=null,this._signalsSortableContainer=null):(this._signalsSortable?.destroy(),this._attachSignalsSortable(i))}_attachRemotesSortable(e){this._remotesSortable=ft.create(e,{handle:".remote-grip",animation:150,ghostClass:"sortable-ghost",onEnd:i=>{const{oldIndex:t,newIndex:a}=i;if(void 0===t||void 0===a||t===a)return;const o=[...this._devices],[r]=o.splice(t,1);o.splice(a,0,r),this._devices=o,this._remotesSortable?.destroy(),this._remotesSortable=null,this._purgeChildren(e,"ha-card"),this._remotesVersion++,this._scheduleRemotesSave(o.map(e=>e.id))}})}_attachSignalsSortable(e){this._expandedDevice&&(this._signalsSortableContainer=e,this._signalsSortable=ft.create(e,{handle:".signal-grip",animation:150,ghostClass:"sortable-ghost",onEnd:i=>{const{oldIndex:t,newIndex:a}=i;if(void 0===t||void 0===a||t===a)return;const o=this._expandedDevice;if(!o)return;const r=[...o.signals],[n]=r.splice(t,1);r.splice(a,0,n),this._expandedDevice={...o,signals:r},this._signalsSortable?.destroy(),this._signalsSortable=null,this._signalsSortableContainer=null,this._purgeChildren(e,".signal-row"),this._signalsVersion++,this._scheduleSignalsSave(o.id,r.map(e=>e.id))}}))}_purgeChildren(e,i){for(const t of Array.from(e.querySelectorAll(i)))t.remove()}_scheduleRemotesSave(e){null!==this._pendingRemotesSave&&clearTimeout(this._pendingRemotesSave),this._pendingRemotesSave=window.setTimeout(async()=>{this._pendingRemotesSave=null;try{await this.api.reorderUnknownDevices("sniffed",e)}catch(e){this._error=`Reorder failed: ${e.message}`,await this._load()}},500)}_scheduleSignalsSave(e,i){null!==this._pendingSignalsSave&&clearTimeout(this._pendingSignalsSave),this._pendingSignalsSave=window.setTimeout(async()=>{this._pendingSignalsSave=null;try{await this.api.reorderUnknownSignals(e,i)}catch(e){this._error=`Reorder failed: ${e.message}`}},500)}async _load(){this._loading=!0;try{const[e,i,t,a]=await Promise.all([this.api.getUnknownDevices({include_dismissed:this._showDismissed,source:"sniffed"}),this.api.listDevices(),this.api.listTriggers(),this.api.getSnifferStatus()]);this._devices=e,this._hairDevices=i,this._triggers=t,this._hasReceivers=a.has_receivers,this._error=null,this.api.listReceivers().then(e=>{this._receivers=e}).catch(()=>{this._receivers=[]})}catch(e){this._error=`Failed to load: ${e.message}`}finally{this._loading=!1}}async _subscribeLive(){try{this._unsubLive=await this.api.subscribeUnknownSignals(e=>{this._onLiveSignal(e)})}catch{}}async _unsubscribeLive(){this._unsubLive&&(await this._unsubLive(),this._unsubLive=null)}async _subscribeRemoved(){try{this._unsubRemoved=await this.api.subscribeSignalRemoved(e=>{this._load(),this._expandedId===e.device_id&&(e.device_removed?(this._expandedId=null,this._expandedDevice=null):(this._toggleExpand(e.device_id),this._toggleExpand(e.device_id)))})}catch{}}async _unsubscribeRemoved(){this._unsubRemoved&&(await this._unsubRemoved(),this._unsubRemoved=null)}async _subscribeDismissActivity(){try{this._unsubDismiss=await this.api.subscribeDismissActivity(()=>this._onDismissActivity())}catch{}}async _unsubscribeDismissActivity(){this._unsubDismiss&&(await this._unsubDismiss(),this._unsubDismiss=null)}_onDismissActivity(){this._dismissDotVisible=!0,this._dismissGlowActive=!0,null!==this._dismissGlowTimer&&clearTimeout(this._dismissGlowTimer),this._dismissGlowTimer=setTimeout(()=>{this._dismissGlowActive=!1,this._dismissGlowTimer=null},wa.DISMISS_GLOW_HOLD_MS)}_startRename(e,i){i.stopPropagation(),this._editingDeviceId=e.id,this._editLabel=e.label??e.protocol??""}async _commitRename(e){const i=this._editLabel.trim();this._editingDeviceId=null;try{const t=await this.api.renameUnknown(e,i),a=this._devices.findIndex(i=>i.id===e);if(a>=0){const e=[...this._devices];e[a]={...e[a],label:t.label},this._devices=e}}catch(e){this._error=`Rename failed: ${e.message}`}}_cancelRename(){this._editingDeviceId=null}_onRenameKeydown(e,i){"Enter"===i.key?this._commitRename(e):"Escape"===i.key&&this._cancelRename()}_onAdoptClick(e,i){i.stopPropagation(),e.linked_devices?.length?this._toggleLinkedPopover(e.id,i):this._promoteTarget=e}_toggleLinkedPopover(e,i){if(i.stopPropagation(),this._linkedPopoverId===e)return void(this._linkedPopoverId=null);const t=i.currentTarget.getBoundingClientRect();this._linkedPopoverPos={top:t.bottom+6,left:Math.max(8,t.right-220)},this._linkedPopoverId=e}_renderLinkedPopover(){if(!this._linkedPopoverId)return"";const e=this._devices.find(e=>e.id===this._linkedPopoverId),i=e?.linked_devices??[];return e&&0!==i.length?B`<div
            ...
            >
                <div class="popover-header">
                    ${$e("sniffer.linked",i.length)}
                </div>
                <button
                    class="popover-item accent"
                    @click=${i=>{i.stopPropagation(),this._linkedPopoverId=null,this._promoteTarget=e}}
                >
                    <span>${ke("wigs.linked_new")}</span>
                </button>
                <div class="popover-divider"></div>
                ${i.map(e=>B`<button
                        class="popover-item"
            ...
            ${this._loading?B`<div class="loading">${ke("sniffer.scanning")}</div>`:0===this._devices.length?this._hasReceivers?B`
                        <ha-card class="empty">
                            <ha-svg-icon class="empty-icon" .path=${xa}></ha-svg-icon>
                    ...
                    `:B`
                        <div class="device-list">
                            ${je(this._remotesVersion,Ne(this._devices,e=>e.id,e=>this._renderDevice(e)))}
                        </div>
                    `}
            ...
            <ha-card class="device ${e.dismissed?"dismissed":""}">
                ...
                >
                    <div class="device-info">
                        <div class="device-header">
                            ...
                            <span class="device-stats ${a?"stats-flash":""}">
                                ...
                                >
                                <span class="stat last-seen" title=${ya(e.last_seen)}>${ka(e.last_seen)}</span>
                            </span>
                    ...
                    ${e.dismissed?"":B`<button
                              ...
                              title=${e.linked_devices?.length?$e("sniffer.linked",e.linked_devices.length):ke("wigs.adopt")}
                              @click=${i=>this._onAdoptClick(e,i)}
                          >${ke("wigs.adopt")}<ir-count-dot
                                  color="green"
                                  .count=${e.linked_devices?.length??0}
                              ></ir-count-dot></button>
                          <button
                              class="action-btn save-wig-btn"
        ...
        `}_renderExpanded(e){return B`
            <div class="expanded">
                ...
                <div class="signal-list">
                    ${je(this._signalsVersion,Ne(e.signals,e=>e.id,i=>{const t=this._recentSignalIds.indexOf(i.id),a=0===t,o=1===t,r=this._glowSignalIds.has(i.id),n=this._hitFlashSignalIds.has(i.id);return B`
                            <div class="signal-row">
                                ...
                                <div class="signal-actions">
                                    <button
                                        class="action-btn assign-btn ${a?"recent-latest":""} ${o?"recent-previous":""} ${r?"glow":""}"
        ...
        `}};za.DISMISS_GLOW_HOLD_MS=3800,za.styles=[Lt,Qt,n`
        .linked-scrim {
            position: fixed;
            inset: 0;
            z-index: 39;
    ...
    `],e([pe({attribute:!1})],za.prototype,"api",void 0),e([pe({attribute:!1})],za.prototype,"hass",void 0),e([ge()],za.prototype,"_devices",void 0),e([ge()],za.prototype,"_hairDevices",void 0),e([ge()],za.prototype,"_loading",void 0),e([ge()],za.prototype,"_saveWigDevice",void 0),e([ge()],za.prototype,"_deleteRemote",void 0),e([ge()],za.prototype,"_linkedPopoverId",void 0),e([ge()],za.prototype,"_error",void 0),e([ge()],za.prototype,"_hasReceivers",void 0),e([ge()],za.prototype,"_showDismissed",void 0),e([ge()],za.prototype,"_expandedId",void 0),e([ge()],za.prototype,"_expandedDevice",void 0),e([ge()],za.prototype,"_flashIds",void 0),e([ge()],za.prototype,"_flashStats",void 0),e([ge()],za.prototype,"_recentSignalIds",void 0),e([ge()],za.prototype,"_glowSignalIds",void 0),e([ge()],za.prototype,"_hitFlashSignalIds",void 0),e([ge()],za.prototype,"_confirmClearAll",void 0),e([ge()],za.prototype,"_triggers",void 0),e([ge()],za.prototype,"_triggerDialog",void 0),e([ge()],za.prototype,"_triggerEditDialog",void 0),e([ge()],za.prototype,"_confirmDeleteTriggerId",void 0),e([ge()],za.prototype,"_triggerPopover",void 0),e([ge()],za.prototype,"_assignedPopover",void 0),e([ge()],za.prototype,"_receivers",void 0),e([ge()],za.prototype,"_editingDeviceId",void 0),e([ge()],za.prototype,"_editLabel",void 0),e([ge()],za.prototype,"_promoteTarget",void 0),e([ge()],za.prototype,"_assignSignal",void 0),e([ge()],za.prototype,"_deleteSignal",void 0),e([ge()],za.prototype,"_editSignal",void 0),e([ge()],za.prototype,"_testingSignalId",void 0),e([ge()],za.prototype,"_testResult",void 0),e([ge()],za.prototype,"_testDialog",void 0),e([ge()],za.prototype,"_testEmitters",void 0),e([ge()],za.prototype,"_dismissGlowActive",void 0),e([ge()],za.prototype,"_dismissDotVisible",void 0),e([ge()],za.prototype,"_remotesVersion",void 0),e([ge()],za.prototype,"_signalsVersion",void 0),za=wa=e([ue("ir-signal-monitor")],za);let Sa=class extends se{constructor(){super(...arguments),this._name="",this._busy=!1,this._error=null,this._brands=[],this._selectedBrand="",this._selectedCodebook="",this._nameEdited=!1}connectedCallback(){super.connectedCallback(),this._loadBrands()}async _loadBrands(){try{this._brands=await this.api.getCodeBrands()}catch{this._brands=[]}}_brand(e){return this._brands.find(i=>i.brand===e)}_codebookLabel(e,i){const t=this._brand(e)?.codebooks.find(e=>e.id===i);return t?.label??""}_maybeAutofillName(){if(this._nameEdited)return;const e=this._brand(this._selectedBrand);if(!e||!this._selectedCodebook)return;const i=this._codebookLabel(this._selectedBrand,this._selectedCodebook);this._name=`${e.label} ${i}`.trim()}_onBrandChange(e){this._selectedBrand=e.target.value;const i=this._brand(this._selectedBrand);i&&1===i.codebooks.length?this._selectedCodebook=i.codebooks[0].id:this._selectedCodebook="",this._maybeAutofillName()}_onCodebookChange(e){this._selectedCodebook=e.target.value,this._maybeAutofillName()}_close(){this.dispatchEvent(new CustomEvent("closed",{bubbles:!0,composed:!0}))}async _create(){if(this._name.trim()){this._busy=!0,this._error=null;try{let e;e=this._selectedCodebook?(await this.api.importCodeRemote(this._selectedCodebook,this._name.trim())).device:await this.api.createRemote(this._name.trim()),this.dispatchEvent(new CustomEvent("remote-created",{detail:e,bubbles:!0,composed:!0}))}catch(e){this._error=e.message}finally{this._busy=!1}}else this._error=ke("common.name_required")}_onKeydown(e){"Enter"===e.key&&this._create()}render(){const e=this._brand(this._selectedBrand);return B`
            <ha-dialog
                open
    ...
    `],e([pe({attribute:!1})],Sa.prototype,"api",void 0),e([ge()],Sa.prototype,"_name",void 0),e([ge()],Sa.prototype,"_busy",void 0),e([ge()],Sa.prototype,"_error",void 0),e([ge()],Sa.prototype,"_brands",void 0),e([ge()],Sa.prototype,"_selectedBrand",void 0),e([ge()],Sa.prototype,"_selectedCodebook",void 0),Sa=e([ue("ir-create-remote-dialog")],Sa);const Ca="M12.462,10.448c-0.639-0.639-1.678-0.639-2.317,0c-0.639,0.639-0.639,1.678,0,2.317l1.09,1.09c0.319,0.319,0.739,0.479,1.159,0.479c0.42,0,0.839-0.16,1.159-0.479c0-0,0-0,0-0c0.639-0.639,0.639-1.678,0-2.317L12.462,10.448z M12.763,13.066c-0.204,0.204-0.535,0.204-0.739,0l-1.09-1.09c-0.204-0.204-0.204-0.535,0-0.739c0.102-0.102,0.236-0.153,0.369-0.153c0.134,0,0.267,0.051,0.369,0.153l1.09,1.09C12.966,12.531,12.966,12.863,12.763,13.066z M23.998,6.609l-0.104-1.419c-0.02-0.276-0.24-0.496-0.516-0.516l-0.938-0.068l-0.068-0.938c-0.02-0.276-0.24-0.496-0.516-0.516l-0.938-0.068l-0.069-0.938c-0.02-0.276-0.24-0.496-0.516-0.516l-0.938-0.068l-0.069-0.938c-0.02-0.276-0.24-0.496-0.516-0.516l-1.419-0.103c-0.162-0.012-0.321,0.047-0.435,0.162l-1.993,1.993c-0,0.001-0.001,0.001-0.001,0.001c-0.097,0.097-0.191,0.197-0.282,0.298c-1.933,2.042-12.871,13.598-13.716,14.551c-0.722,0.814-0.712,1.983,0.023,2.717l0.341,0.341L0.539,20.852c-0.719,0.719-0.719,1.889,0,2.609c0.36,0.36,0.832,0.539,1.304,0.539c0.472,0,0.945-0.18,1.304-0.539l0.787-0.787l0.341,0.341c0.735,0.735,1.903,0.745,2.717,0.023c0.953-0.845,12.509-11.783,14.551-13.716c0.102-0.091,0.201-0.186,0.299-0.283c0.001-0.001,0.001-0.001,0.001-0.002l1.992-1.992C23.951,6.93,24.01,6.771,23.998,6.609z M20.61,4.179l0.684,0.05l0.05,0.684l-1.418,1.418l-0.733-0.734L20.61,4.179z M19.087,2.656l0.684,0.05l0.05,0.684L18.403,4.807L17.67,4.074L19.087,2.656z M17.564,1.133l0.684,0.05l0.05,0.684l-1.418,1.418l-0.733-0.733L17.564,1.133z M2.359,22.671c-0.284,0.284-0.746,0.284-1.03,0c-0.284-0.284-0.284-0.746,0-1.03l0.787-0.787l1.03,1.03L2.359,22.671z M6.253,22.202c-0.366,0.324-0.877,0.334-1.188,0.023l-0.735-0.735l-2.555-2.555c-0.311-0.311-0.301-0.822,0.023-1.188c0.633-0.715,7.3-7.769,11.189-11.88c-0.014,0.084-0.026,0.169-0.036,0.253c-0.179,1.482,0.239,2.815,1.176,3.752c0.937,0.937,2.27,1.355,3.752,1.176c0.084-0.01,0.169-0.022,0.253-0.036C14.022,14.901,6.968,21.568,6.253,22.202z M14.917,9.083c-0.69-0.69-0.994-1.694-0.857-2.829c0.123-1.019,0.585-2.03,1.315-2.897l0.717,0.717l-0.879,0.879c-0.218,0.218-0.218,0.571,0,0.789c0.218,0.218,0.571,0.218,0.789,0l0.879-0.879l0.734,0.734l-0.879,0.879c-0.218,0.218-0.218,0.571,0,0.789c0.218,0.218,0.571,0.218,0.789,0l0.879-0.879l0.734,0.734l-0.879,0.879c-0.218,0.218-0.218,0.571,0,0.789c0.218,0.218,0.571,0.218,0.789,0l0.879-0.879l0.717,0.717C18.756,10.213,16.277,10.443,14.917,9.083z M21.449,7.853l-0.734-0.734l1.418-1.418l0.684,0.05l0.05,0.684L21.449,7.853z",Aa="M7,19V17H9V19H7M11,19V17H13V19H11M15,19V17H17V19H15M7,15V13H9V15H7M11,15V13H13V15H11M15,15V13H17V15H15M7,11V9H9V11H7M11,11V9H13V11H11M15,11V9H17V11H15M7,7V5H9V7H7M11,7V5H13V7H11M15,7V5H17V7H15Z";let Da=class extends se{constructor(){super(...arguments),this._devices=[],this._hairDevices=[],this._triggers=[],this._loading=!0,this._saveWigDevice=null,this._wigDragOver=!1,this._error=null,this._expandedId=null,this._expandedDevice=null,this._confirmClearAll=!1,this._deleteRemoteId=null,this._deleteRemoteLabel="",this._deleteRemoteCount=0,this._editingDeviceId=null,this._editLabel="",this._createRemoteOpen=!1,this._createSignalDeviceId=null,this._editSignal=null,this._promoteTarget=null,this._signpostTarget=null,this._adoptWigTarget=null,this._linkedPopoverId=null,this._linkedPopoverPos={top:0,left:0},this._assignSignal=null,this._deleteSignal=null,this._triggerDialog=null,this._triggerEditDialog=null,this._triggerPopover=null,this._assignedPopover=null,this._receivers=[],this._unsubUpdated=null,this._confirmDeleteTriggerId=null,this._testDialog=null,this._testEmitters=[],this._testingSignalId=null,this._testResult=null,this._remotesVersion=0,this._signalsVersion=0,this._remotesSortable=null,this._signalsSortable=null,this._signalsSortableContainer=null,this._pendingRemotesSave=null,this._pendingSignalsSave=null,this._onDocClickForPopover=e=>{const i=e.composedPath(),t=this.shadowRoot?.querySelector("ir-trigger-popover"),a=this.shadowRoot?.querySelector("ir-assigned-popover");t&&i.includes(t)||a&&i.includes(a)||(this._closeTriggerPopover(),this._closeAssignedPopover())},this._onScrollForPopover=()=>{this._closeTriggerPopover(),this._closeAssignedPopover()}}connectedCallback(){super.connectedCallback(),this._load(),this._subscribeUpdated()}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribeUpdated(),this._removePopoverDismiss(),this._remotesSortable?.destroy(),this._remotesSortable=null,this._signalsSortable?.destroy(),this._signalsSortable=null,this._signalsSortableContainer=null,null!==this._pendingRemotesSave&&clearTimeout(this._pendingRemotesSave),null!==this._pendingSignalsSave&&clearTimeout(this._pendingSignalsSave)}updated(e){if(super.updated(e),e.has("_editingDeviceId")&&this._editingDeviceId){const e=this.shadowRoot?.querySelector(".rename-input");e?.focus(),e?.select()}this._syncSortables()}_syncSortables(){const e=this.renderRoot.querySelector(".device-list");e&&!this._remotesSortable?this._attachRemotesSortable(e):!e&&this._remotesSortable&&(this._remotesSortable.destroy(),this._remotesSortable=null);const i=this.renderRoot.querySelector(".signal-list"),t=!!this._expandedDevice&&!this._expandedDevice.dismissed;!i||!t||this._signalsSortable&&this._signalsSortableContainer===i?i&&t||!this._signalsSortable||(this._signalsSortable.destroy(),this._signalsSortable=null,this._signalsSortableContainer=null):(this._signalsSortable?.destroy(),this._attachSignalsSortable(i))}_attachRemotesSortable(e){this._remotesSortable=ft.create(e,{handle:".remote-grip",animation:150,ghostClass:"sortable-ghost",onEnd:i=>{const{oldIndex:t,newIndex:a}=i;if(void 0===t||void 0===a||t===a)return;const o=[...this._devices],[r]=o.splice(t,1);o.splice(a,0,r),this._devices=o,this._remotesSortable?.destroy(),this._remotesSortable=null,this._purgeChildren(e,"ha-card"),this._remotesVersion++,this._scheduleRemotesSave(o.map(e=>e.id))}})}_attachSignalsSortable(e){this._expandedDevice&&(this._signalsSortableContainer=e,this._signalsSortable=ft.create(e,{handle:".signal-grip",animation:150,ghostClass:"sortable-ghost",onEnd:i=>{const{oldIndex:t,newIndex:a}=i;if(void 0===t||void 0===a||t===a)return;const o=this._expandedDevice;if(!o)return;const r=[...o.signals],[n]=r.splice(t,1);r.splice(a,0,n),this._expandedDevice={...o,signals:r},this._signalsSortable?.destroy(),this._signalsSortable=null,this._signalsSortableContainer=null,this._purgeChildren(e,".signal-row"),this._signalsVersion++,this._scheduleSignalsSave(o.id,r.map(e=>e.id))}}))}_purgeChildren(e,i){for(const t of Array.from(e.querySelectorAll(i)))t.remove()}_scheduleRemotesSave(e){null!==this._pendingRemotesSave&&clearTimeout(this._pendingRemotesSave),this._pendingRemotesSave=window.setTimeout(async()=>{this._pendingRemotesSave=null;try{await this.api.reorderUnknownDevices("manual",e)}catch(e){this._error=`Reorder failed: ${e.message}`,await this._load()}},500)}_scheduleSignalsSave(e,i){null!==this._pendingSignalsSave&&clearTimeout(this._pendingSignalsSave),this._pendingSignalsSave=window.setTimeout(async()=>{this._pendingSignalsSave=null;try{await this.api.reorderUnknownSignals(e,i)}catch(e){this._error=`Reorder failed: ${e.message}`,await this._refreshExpanded()}},500)}async _onWigDrop(e){e.preventDefault(),this._wigDragOver=!1;const i=e.dataTransfer?.files;if(i&&0!==i.length){for(const e of Array.from(i))try{const i=await this.api.wigsUpload(await e.text(),e.name);if(!i.success){this._error=ke("wigs.upload_failed",{reason:(i.errors??[]).join("; ")});continue}const t=i.filenames??[i.filename??""];for(const e of t)e&&await this.api.importCodeRemote(`wig:${e}`)}catch(e){this._error=ke("wigs.upload_failed",{reason:e.message})}await this._load()}}async _load(){this._loading=!0;try{const[e,i,t]=await Promise.all([this.api.getUnknownDevices({include_dismissed:!0,min_hits:0,source:"manual"}),this.api.listDevices(),this.api.listTriggers()]);this._devices=e,this._hairDevices=i,this._triggers=t,this._error=null,this.api.listReceivers().then(e=>{this._receivers=e}).catch(()=>{this._receivers=[]})}catch(e){this._error=`Failed to load: ${e.message}`}finally{this._loading=!1}}async _refreshExpanded(){if(this._expandedId)try{this._expandedDevice=await this.api.getUnknownDevice(this._expandedId)}catch{this._expandedId=null,this._expandedDevice=null}}openCreateRemote(){this._createRemoteOpen=!0}async _onRemoteCreated(e){this._createRemoteOpen=!1,await this._load(),this._expandedId=e.detail.id,await this._refreshExpanded()}_openCreateSignal(e,i){i.stopPropagation(),this._createSignalDeviceId=e}async _onSignalCreated(){this._createSignalDeviceId=null,await this._refreshExpanded(),await this._load()}_openEditSignal(e,i,t){t.stopPropagation(),this._editSignal={deviceId:e,signal:i}}async _onSignalEdited(){this._editSignal=null,await this._refreshExpanded(),await this._load()}_openDeleteRemote(e){this._deleteRemoteId=e.id,this._deleteRemoteLabel=e.label||"this remote",this._deleteRemoteCount=e.signal_count}async _confirmDeleteRemote(){const e=this._deleteRemoteId;if(this._deleteRemoteId=null,e)try{await this.api.deleteRemote(e),this._expandedId===e&&(this._expandedId=null,this._expandedDevice=null),await this._load()}catch(e){this._error=`Delete failed: ${e.message}`}}_onAliasChanged(e){const{id:i,alias:t}=e.detail;this._expandedDevice&&(this._expandedDevice={...this._expandedDevice,signals:this._expandedDevice.signals.map(e=>e.id===i?{...e,alias:t}:e)})}_startRename(e,i){i.stopPropagation(),this._editingDeviceId=e.id,this._editLabel=e.label??""}async _commitRename(e){const i=this._editLabel.trim();this._editingDeviceId=null;try{const t=await this.api.renameUnknown(e,i),a=this._devices.findIndex(i=>i.id===e);if(a>=0){const e=[...this._devices];e[a]={...e[a],label:t.label},this._devices=e}}catch(e){this._error=`Rename failed: ${e.message}`}}_onRenameKeydown(e,i){"Enter"===i.key?this._commitRename(e):"Escape"===i.key&&(this._editingDeviceId=null)}_onAdoptClick(e,i){i.stopPropagation(),e.linked_devices?.length?this._toggleLinkedPopover(e.id,i):this._openAdopt(e)}_openAdopt(e){e.source_wig?this._signpostTarget=e:this._promoteTarget=e}_signpostFilename(e){return e.source_wig_filename??e.source_wig?.filename??""}_signpostAdoptFlat(){const e=this._signpostTarget;this._signpostTarget=null,e&&(this._promoteTarget=e)}_signpostAdoptWig(){const e=this._signpostTarget;this._signpostTarget=null,e&&(this._adoptWigTarget={filename:this._signpostFilename(e),suggestedName:e.label??""})}_renderSignpost(){const e=this._signpostTarget;if(!e)return"";const i="gone"===(e.source_wig_state??"gone"),t=this._signpostFilename(e);return B`<div
        ...
        >
        ...
        </div>`}async _onWigRoadAdopted(){this._adoptWigTarget=null,await this._load()}_toggleLinkedPopover(e,i){if(i.stopPropagation(),this._linkedPopoverId===e)return void(this._linkedPopoverId=null);const t=i.currentTarget.getBoundingClientRect();this._linkedPopoverPos={top:t.bottom+6,left:Math.max(8,t.right-220)},this._linkedPopoverId=e}_renderLinkedPopover(){if(!this._linkedPopoverId)return"";const e=this._devices.find(e=>e.id===this._linkedPopoverId),i=e?.linked_devices??[];return e&&0!==i.length?B`<div
                class="linked-scrim"
                @click=${()=>this._linkedPopoverId=null}
            ></div>
            <div
            ...
            >
                ...
                <button
                    class="popover-item accent"
                    @click=${i=>{i.stopPropagation(),this._linkedPopoverId=null,this._openAdopt(e)}}
                >
                    <span>${ke("wigs.linked_new")}</span>
                </button>
                <div class="popover-divider"></div>
            ...
            ${this._loading?B`<div class="loading">${ke("common.loading_plain")}</div>`:0===e?B`
                        <ha-card class="empty">
                            <ha-svg-icon class="empty-icon" .path=${Ca}></ha-svg-icon>
        ...
        `}_renderExpanded(e){return B`
            <div class="expanded">
                ...
                ${0===e.signals.length?B`<div class="no-signals-row">
                          ...
                          <div class="signal-list">
                              ${je(this._signalsVersion,Ne(e.signals,e=>e.id,i=>this._renderSignal(e.id,i,e.label)))}
                          </div>
                      `}
            </div>
        ...
        `}_renderDialogs(){return B`
            ...
            ${this._adoptWigTarget?B`<ir-promote-dialog
                      .api=${this.api}
                      .hass=${this.hass}
    ...
    `],e([pe({attribute:!1})],Ea.prototype,"api",void 0),e([pe({attribute:!1})],Ea.prototype,"blaster",void 0),e([pe()],Ea.prototype,"integration",void 0),e([ge()],Ea.prototype,"_commandName",void 0),e([ge()],Ea.prototype,"_busy",void 0),e([ge()],Ea.prototype,"_creating",void 0),e([ge()],Ea.prototype,"_error",void 0),e([ge()],Ea.prototype,"_captures",void 0),e([ge()],Ea.prototype,"_aliases",void 0),e([ge()],Ea.prototype,"_validations",void 0),Ea=e([ue("ir-pluck-signal-dialog")],Ea);const Ta="M0.861,24c-0.22,0-0.441-0.084-0.609-0.252c-0.336-0.336-0.336-0.882,0-1.218l1.563-1.563c1.648-1.649,3.474-4.166,5.588-7.082c2.984-4.116,6.367-8.781,10.695-13.109c0.081-0.081,0.178-0.145,0.284-0.189l1.283-0.523c0.441-0.18,0.943,0.032,1.123,0.472l-0.472,1.123L19.194,2.116c-4.175,4.199-7.478,8.755-10.397,12.78c-0.275,0.379-0.545,0.752-0.811,1.117c0.365-0.266,0.738-0.536,1.117-0.811C13.128,12.284,17.685,8.98,21.884,4.806l0.457-1.121L23.464,3.212c0.44,0.18,0.652,0.682,0.472,1.123l-0.523,1.283c-0.043,0.106-0.107,0.203-0.188,0.284c-4.329,4.329-8.994,7.711-13.109,10.695c-2.915,2.114-5.433,3.939-7.082,5.588l-1.563,1.563C1.302,23.916,1.082,24,0.861,24z",Pa="M7,19V17H9V19H7M11,19V17H13V19H11M15,19V17H17V19H15M7,15V13H9V15H7M11,15V13H13V15H11M15,15V13H17V15H15M7,11V9H9V11H7M11,11V9H13V11H11M15,11V9H17V11H15M7,7V5H9V7H7M11,7V5H13V7H11M15,7V5H17V7H15Z";let Ra=class extends se{constructor(){super(...arguments),this.pendingEntity="",this._devices=[],this._hairDevices=[],this._triggers=[],this._loading=!0,this._saveWigDevice=null,this._error=null,this._expandedId=null,this._expandedDevice=null,this._confirmClearAll=!1,this._deleteRemoteId=null,this._deleteRemoteLabel="",this._deleteRemoteCount=0,this._vendorIntegration={},this._editingDeviceId=null,this._editLabel="",this._createRemoteOpen=!1,this._promoteTarget=null,this._linkedPopoverId=null,this._linkedPopoverPos={top:0,left:0},this._pluckDialog=null,this._editSignal=null,this._assignSignal=null,this._deleteSignal=null,this._triggerDialog=null,this._triggerEditDialog=null,this._triggerPopover=null,this._assignedPopover=null,this._receivers=[],this._unsubUpdated=null,this._confirmDeleteTriggerId=null,this._testDialog=null,this._testEmitters=[],this._testingSignalId=null,this._testResult=null,this._remotesVersion=0,this._signalsVersion=0,this._remotesSortable=null,this._signalsSortable=null,this._signalsSortableContainer=null,this._pendingRemotesSave=null,this._pendingSignalsSave=null,this._onDocClickForPopover=e=>{const i=e.composedPath(),t=this.shadowRoot?.querySelector("ir-trigger-popover"),a=this.shadowRoot?.querySelector("ir-assigned-popover");t&&i.includes(t)||a&&i.includes(a)||(this._closeTriggerPopover(),this._closeAssignedPopover())},this._onScrollForPopover=()=>{this._closeTriggerPopover(),this._closeAssignedPopover()}}connectedCallback(){super.connectedCallback(),this._load(),this._subscribeUpdated()}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribeUpdated(),this._removePopoverDismiss(),this._remotesSortable?.destroy(),this._remotesSortable=null,this._signalsSortable?.destroy(),this._signalsSortable=null,this._signalsSortableContainer=null,null!==this._pendingRemotesSave&&clearTimeout(this._pendingRemotesSave),null!==this._pendingSignalsSave&&clearTimeout(this._pendingSignalsSave)}updated(e){if(super.updated(e),e.has("_editingDeviceId")&&this._editingDeviceId){const e=this.shadowRoot?.querySelector(".rename-input");e?.focus(),e?.select()}this._syncSortables()}_syncSortables(){const e=this.renderRoot.querySelector(".device-list");e&&!this._remotesSortable?this._attachRemotesSortable(e):!e&&this._remotesSortable&&(this._remotesSortable.destroy(),this._remotesSortable=null);const i=this.renderRoot.querySelector(".signal-list"),t=!!this._expandedDevice;!i||!t||this._signalsSortable&&this._signalsSortableContainer===i?i&&t||!this._signalsSortable||(this._signalsSortable.destroy(),this._signalsSortable=null,this._signalsSortableContainer=null):(this._signalsSortable?.destroy(),this._attachSignalsSortable(i))}_attachRemotesSortable(e){this._remotesSortable=ft.create(e,{handle:".remote-grip",animation:150,ghostClass:"sortable-ghost",onEnd:i=>{const{oldIndex:t,newIndex:a}=i;if(void 0===t||void 0===a||t===a)return;const o=[...this._devices],[r]=o.splice(t,1);o.splice(a,0,r),this._devices=o,this._remotesSortable?.destroy(),this._remotesSortable=null,this._purgeChildren(e,"ha-card"),this._remotesVersion++,this._scheduleRemotesSave(o.map(e=>e.id))}})}_attachSignalsSortable(e){this._expandedDevice&&(this._signalsSortableContainer=e,this._signalsSortable=ft.create(e,{handle:".signal-grip",animation:150,ghostClass:"sortable-ghost",onEnd:i=>{const{oldIndex:t,newIndex:a}=i;if(void 0===t||void 0===a||t===a)return;const o=this._expandedDevice;if(!o)return;const r=[...o.signals],[n]=r.splice(t,1);r.splice(a,0,n),this._expandedDevice={...o,signals:r},this._signalsSortable?.destroy(),this._signalsSortable=null,this._signalsSortableContainer=null,this._purgeChildren(e,".signal-row"),this._signalsVersion++,this._scheduleSignalsSave(o.id,r.map(e=>e.id))}}))}_purgeChildren(e,i){for(const t of Array.from(e.querySelectorAll(i)))t.remove()}_scheduleRemotesSave(e){null!==this._pendingRemotesSave&&clearTimeout(this._pendingRemotesSave),this._pendingRemotesSave=window.setTimeout(async()=>{this._pendingRemotesSave=null;try{await this.api.reorderUnknownDevices("plucked",e)}catch(e){this._error=`Reorder failed: ${e.message}`,await this._load()}},500)}_scheduleSignalsSave(e,i){null!==this._pendingSignalsSave&&clearTimeout(this._pendingSignalsSave),this._pendingSignalsSave=window.setTimeout(async()=>{this._pendingSignalsSave=null;try{await this.api.reorderUnknownSignals(e,i)}catch(e){this._error=`Reorder failed: ${e.message}`,await this._refreshExpanded()}},500)}async _load(){this._loading=!0;try{const[e,i,t,a]=await Promise.all([this.api.getUnknownDevices({include_dismissed:!1,min_hits:0,source:"plucked"}),this.api.listDevices(),this.api.listTriggers(),this.api.listPluckVendors().catch(()=>({vendors:[]}))]);this._devices=e,this._hairDevices=i,this._triggers=t,this._vendorIntegration=this._mapIntegrations(a.vendors),this._error=null,this.api.listReceivers().then(e=>{this._receivers=e}).catch(()=>{this._receivers=[]})}catch(e){this._error=`Failed to load: ${e.message}`}finally{this._loading=!1}}_mapIntegrations(e){const i={};for(const t of e)for(const e of t.blasters)i[e.entity_id]=t.integration;return i}async _refreshExpanded(){if(this._expandedId)try{this._expandedDevice=await this.api.getUnknownDevice(this._expandedId)}catch{this._expandedId=null,this._expandedDevice=null}}openCreateRemote(){this._createRemoteOpen=!0}async _onBlasterCreated(e){this._createRemoteOpen=!1,this.pendingEntity="",await this._load(),this._expandedId=e.detail.id,await this._refreshExpanded()}_openPluckSignal(e,i){i.stopPropagation();const t=e.vendor_entity_id?this._vendorIntegration[e.vendor_entity_id]??"":"";t?this._pluckDialog={device:e,integration:t}:this._error=ke("pluck.vendor_unavailable")}async _onSignalsCreated(){this._pluckDialog=null,await this._refreshExpanded(),await this._load()}_openEditSignal(e,i,t){t.stopPropagation(),this._editSignal={deviceId:e,signal:i}}async _onSignalEdited(){this._editSignal=null,await this._refreshExpanded(),await this._load()}_openDeleteRemote(e){this._deleteRemoteId=e.id,this._deleteRemoteLabel=e.label||"this blaster",this._deleteRemoteCount=e.signal_count}async _confirmDeleteRemote(){const e=this._deleteRemoteId;if(this._deleteRemoteId=null,e)try{await this.api.deletePluckedBlaster(e),this._expandedId===e&&(this._expandedId=null,this._expandedDevice=null),await this._load()}catch(e){this._error=`Delete failed: ${e.message}`}}async _doClearAll(){this._confirmClearAll=!1;try{await this.api.clearUnknowns("plucked"),this._devices=[],this._expandedId=null,this._expandedDevice=null}catch(e){this._error=`Clear failed: ${e.message}`}}_onAliasChanged(e){const{id:i,alias:t}=e.detail;this._expandedDevice&&(this._expandedDevice={...this._expandedDevice,signals:this._expandedDevice.signals.map(e=>e.id===i?{...e,alias:t}:e)})}_startRename(e,i){i.stopPropagation(),this._editingDeviceId=e.id,this._editLabel=e.label??""}async _commitRename(e){const i=this._editLabel.trim();this._editingDeviceId=null;try{const t=await this.api.renameUnknown(e,i),a=this._devices.findIndex(i=>i.id===e);if(a>=0){const e=[...this._devices];e[a]={...e[a],label:t.label},this._devices=e}}catch(e){this._error=`Rename failed: ${e.message}`}}_onRenameKeydown(e,i){"Enter"===i.key?this._commitRename(e):"Escape"===i.key&&(this._editingDeviceId=null)}_openAssign(e,i,t){this._assignSignal={deviceId:e,signal:i,label:t??null}}_onAssignClick(e,i,t,a){if(!i.assigned_to?.length)return void this._openAssign(e,i,t);const o=a?.currentTarget,r=o?.getBoundingClientRect();this._assignedPopover={deviceId:e,signal:i,label:t??null,top:r?r.bottom+4:120,left:r?Math.max(8,r.right-220):120},this._installPopoverDismiss()}_closeAssignedPopover(){this._assignedPopover=null,this._removePopoverDismiss()}_onAssignedPopoverCreateNew(){const e=this._assignedPopover;this._closeAssignedPopover(),e&&this._openAssign(e.deviceId,e.signal,e.label)}_onAssignedPopoverOpen(e){const i=e.detail;this._closeAssignedPopover(),i&&this.dispatchEvent(new CustomEvent("navigate-device",{detail:i.device_id,bubbles:!0,composed:!0}))}async _onSignalAssigned(e){this._assignSignal=null,await this._load(),await this._refreshExpanded()}_onAdoptClick(e,i){i.stopPropagation(),e.linked_devices?.length?this._toggleLinkedPopover(e.id,i):this._promoteTarget=e}_toggleLinkedPopover(e,i){if(i.stopPropagation(),this._linkedPopoverId===e)return void(this._linkedPopoverId=null);const t=i.currentTarget.getBoundingClientRect();this._linkedPopoverPos={top:t.bottom+6,left:Math.max(8,t.right-220)},this._linkedPopoverId=e}_renderLinkedPopover(){if(!this._linkedPopoverId)return"";const e=this._devices.find(e=>e.id===this._linkedPopoverId),i=e?.linked_devices??[];return e&&0!==i.length?B`<div
            ...
            </div>`:""}_navigateToDevice(e){this.dispatchEvent(new CustomEvent("navigate-device",{detail:e,bubbles:!0,composed:!0}))}async _onDevicePromoted(){this._promoteTarget=null,await this._load()}_openDelete(e,i){this._deleteSignal={deviceId:e,signal:i}}async _confirmDelete(){if(!this._deleteSignal)return;const{deviceId:e,signal:i}=this._deleteSignal;this._deleteSignal=null;try{await this.api.deleteSignal(e,i.id),await this._load(),await this._refreshExpanded()}catch(e){this._error=`Delete failed: ${e.message}`}}_openTestDialog(e){this._testDialog={signal:e}}async _sendTest(e){if(!this._testDialog)return;const{signal:i}=this._testDialog,t=e.detail.emitters;if(0!==t.length){this._testingSignalId=i.id,this._testResult=null,this._testDialog=null;try{const e=(await Promise.allSettled(t.map(e=>this.api.testSignal(i.id,e)))).filter(e=>"fulfilled"===e.status&&e.value.sent).length,a=t.length;this._testResult=e===a?1===a?ke("mirror.sent"):ke("mirror.sent_all_n",{sent:e,total:a}):0===e?ke("mirror.failed"):`Sent (${e}/${a})`}catch{this._testResult="Error"}setTimeout(()=>{this._testResult=null,this._testingSignalId=null},3e3)}}_hasTrigger(e){return this._triggers.some(i=>ba(i,e))}_triggerCountFor(e){return this._triggers.filter(i=>ba(i,e)).length}_openTriggerDialog(e,i,t){const a=this._triggers.filter(e=>ba(e,i));if(0===a.length)return void(this._triggerDialog={signal:i,deviceId:e});const o=t?.currentTarget,r=o?.getBoundingClientRect();this._triggerPopover={deviceId:e,signal:i,top:r?r.bottom+4:120,left:r?Math.max(8,r.right-220):120},this._installPopoverDismiss()}_closeTriggerPopover(){this._triggerPopover=null,this._removePopoverDismiss()}_onPopoverCreateNew(){const e=this._triggerPopover;this._closeTriggerPopover(),e&&(this._triggerDialog={signal:e.signal,deviceId:e.deviceId})}_onPopoverEditTrigger(e){const i=e.detail;this._closeTriggerPopover(),i&&(this._triggerEditDialog=i)}_installPopoverDismiss(){setTimeout(()=>{document.addEventListener("click",this._onDocClickForPopover,!0),window.addEventListener("scroll",this._onScrollForPopover,!0)},0)}_removePopoverDismiss(){document.removeEventListener("click",this._onDocClickForPopover,!0),window.removeEventListener("scroll",this._onScrollForPopover,!0)}async _subscribeUpdated(){try{this._unsubUpdated=await this.api.subscribeSignalUpdated(()=>{this._refreshAfterSignalUpdate()})}catch{}}async _unsubscribeUpdated(){this._unsubUpdated&&(await this._unsubUpdated(),this._unsubUpdated=null)}async _refreshAfterSignalUpdate(){try{this._triggers=await this.api.listTriggers()}catch{}if(this._expandedId)try{this._expandedDevice=await this.api.getUnknownDevice(this._expandedId)}catch{}}_closeTriggerDialog(){this._triggerDialog=null,this._triggerEditDialog=null}_requestDeleteTrigger(e){this._confirmDeleteTriggerId=e}async _doDeleteTrigger(){if(!this._confirmDeleteTriggerId)return;const e=this._confirmDeleteTriggerId;this._confirmDeleteTriggerId=null,this._triggerEditDialog=null;try{await this.api.deleteTrigger(e),this._triggers=await this.api.listTriggers()}catch{}}async _onTriggerSaved(){this._triggerDialog=null,this._triggerEditDialog=null;try{this._triggers=await this.api.listTriggers()}catch{}}async _toggleExpand(e){if(this._expandedId===e)return this._expandedId=null,void(this._expandedDevice=null);this._expandedId=e,await this._refreshExpanded()}render(){const e=this._devices.length;return B`
            <div class="toolbar">
                <span class="title">
            ...
            ${this._loading?B`<div class="loading">${ke("common.loading_plain")}</div>`:0===e?B`
                        <ha-card class="empty">
                            <ha-svg-icon class="empty-icon" .path=${Ta}></ha-svg-icon>
        ...
        `}_renderDevice(e){const i=this._expandedId===e.id;return B`
            <ha-card class="device pluck-device">
                <div class="device-row" @click=${()=>this._toggleExpand(e.id)}>
                    ...
                    <button
                        class="action-btn adopt-btn"
                        title=${e.linked_devices?.length?$e("sniffer.linked",e.linked_devices.length):ke("pluck.promote_title")}
                        @click=${i=>this._onAdoptClick(e,i)}
                    >${ke("wigs.adopt")}<ir-count-dot
                            color="green"
                            .count=${e.linked_devices?.length??0}
        ...
        `}_renderDialogs(){return B`
            ...
            ${this._saveWigDevice?B`<ir-save-wig-dialog
                      ...
                      @closed=${()=>this._saveWigDevice=null}
                  ></ir-save-wig-dialog>`:""}
        `}};function ja(e){if(!e)return"";try{const i=Date.now()-new Date(e).getTime();return i<6e4?ke("rel.just_now"):i<36e5?`${Math.floor(i/6e4)}m`:i<864e5?`${Math.floor(i/36e5)}h`:`${Math.floor(i/864e5)}d`}catch{return""}}Ra.styles=[Lt,Qt,n`
        .linked-scrim {
            position: fixed;
            inset: 0;
            z-index: 39;
    ...
    `],e([pe({attribute:!1})],Ra.prototype,"api",void 0),e([pe({attribute:!1})],Ra.prototype,"hass",void 0),e([pe()],Ra.prototype,"pendingEntity",void 0),e([ge()],Ra.prototype,"_devices",void 0),e([ge()],Ra.prototype,"_hairDevices",void 0),e([ge()],Ra.prototype,"_triggers",void 0),e([ge()],Ra.prototype,"_loading",void 0),e([ge()],Ra.prototype,"_saveWigDevice",void 0),e([ge()],Ra.prototype,"_error",void 0),e([ge()],Ra.prototype,"_expandedId",void 0),e([ge()],Ra.prototype,"_expandedDevice",void 0),e([ge()],Ra.prototype,"_confirmClearAll",void 0),e([ge()],Ra.prototype,"_deleteRemoteId",void 0),e([ge()],Ra.prototype,"_deleteRemoteLabel",void 0),e([ge()],Ra.prototype,"_deleteRemoteCount",void 0),e([ge()],Ra.prototype,"_editingDeviceId",void 0),e([ge()],Ra.prototype,"_editLabel",void 0),e([ge()],Ra.prototype,"_createRemoteOpen",void 0),e([ge()],Ra.prototype,"_promoteTarget",void 0),e([ge()],Ra.prototype,"_linkedPopoverId",void 0),e([ge()],Ra.prototype,"_pluckDialog",void 0),e([ge()],Ra.prototype,"_editSignal",void 0),e([ge()],Ra.prototype,"_assignSignal",void 0),e([ge()],Ra.prototype,"_deleteSignal",void 0),e([ge()],Ra.prototype,"_triggerDialog",void 0),e([ge()],Ra.prototype,"_triggerEditDialog",void 0),e([ge()],Ra.prototype,"_triggerPopover",void 0),e([ge()],Ra.prototype,"_assignedPopover",void 0),e([ge()],Ra.prototype,"_receivers",void 0),e([ge()],Ra.prototype,"_confirmDeleteTriggerId",void 0),e([ge()],Ra.prototype,"_testDialog",void 0),e([ge()],Ra.prototype,"_testEmitters",void 0),e([ge()],Ra.prototype,"_testingSignalId",void 0),e([ge()],Ra.prototype,"_testResult",void 0),e([ge()],Ra.prototype,"_remotesVersion",void 0),e([ge()],Ra.prototype,"_signalsVersion",void 0),Ra=e([ue("ir-pluck")],Ra);const Ma="M 19.39,4.60 C 16.51,1.71 11.78,1.71 8.89,4.60 C 6.00,7.49 6.00,12.21 8.89,15.10 C 11.78,17.99 16.51,17.99 19.39,15.10 C 22.28,12.21 22.28,7.49 19.39,4.60 M 9.29,14.70 C 6.63,12.03 6.63,7.67 9.29,5.00 C 11.96,2.34 16.32,2.34 18.99,5.00 C 21.66,7.67 21.66,12.03 18.99,14.70 C 16.32,17.36 11.96,17.36 9.29,14.70 M 4.85,19.14 C 4.29,18.58 3.40,18.58 2.83,19.14 C 2.27,19.71 2.27,20.60 2.83,21.16 C 3.40,21.73 4.29,21.73 4.85,21.16 C 5.42,20.60 5.42,19.71 4.85,19.14 M 3.24,20.76 C 2.89,20.41 2.89,19.89 3.24,19.55 C 3.58,19.20 4.10,19.20 4.45,19.55 C 4.79,19.89 4.79,20.41 4.45,20.76 C 4.10,21.10 3.58,21.10 3.24,20.76 M 22.99,9.57 C 22.91,7.10 21.84,4.82 19.98,3.20 C 16.65,0.28 11.62,0.26 8.31,3.20 C 5.52,5.67 4.57,9.49 5.86,12.96 C 6.33,14.19 6.02,15.55 5.13,16.43 C 4.65,16.92 4.04,17.24 3.40,17.32 C 2.79,17.40 2.25,17.71 1.82,18.13 C 0.75,19.20 0.73,21.00 1.78,22.09 C 1.80,22.11 1.82,22.13 1.84,22.15 C 2.37,22.68 3.07,22.98 3.82,23.00 C 4.61,23.02 5.32,22.72 5.88,22.15 C 6.31,21.73 6.57,21.18 6.67,20.60 C 6.77,19.93 7.07,19.34 7.56,18.86 C 8.45,17.97 9.82,17.69 11.03,18.13 C 14.28,19.36 17.96,18.56 20.40,16.11 C 22.12,14.39 23.07,11.99 22.99,9.57 M 11.23,17.61 C 9.82,17.08 8.20,17.40 7.15,18.45 C 6.59,19.02 6.22,19.75 6.10,20.51 C 6.02,21.00 5.80,21.42 5.46,21.77 C 5.01,22.21 4.43,22.43 3.82,22.43 C 3.17,22.43 2.61,22.19 2.18,21.73 C 1.34,20.84 1.38,19.42 2.21,18.56 C 2.55,18.21 2.99,17.97 3.48,17.89 C 4.25,17.77 4.97,17.40 5.54,16.84 C 6.59,15.79 6.93,14.19 6.39,12.76 C 5.17,9.53 6.06,5.93 8.69,3.63 C 11.80,0.88 16.49,0.88 19.60,3.63 C 19.74,3.73 19.88,3.87 20.00,3.99 C 21.49,5.49 22.36,7.45 22.42,9.57 C 22.48,11.89 21.64,14.07 20.00,15.71 C 17.70,18.01 14.26,18.74 11.23,17.61 M 17.58,10.86 L 10.71,10.86 C 10.55,10.86 10.43,10.98 10.43,11.14 C 10.43,11.22 10.47,11.30 10.51,11.34 C 10.55,11.38 10.63,11.43 10.71,11.43 L 17.58,11.43 C 17.74,11.43 17.86,11.30 17.86,11.14 C 17.86,10.98 17.72,10.88 17.58,10.86 M 17.88,8.54 C 17.88,8.38 17.76,8.25 17.60,8.25 L 10.73,8.25 C 10.57,8.25 10.45,8.38 10.45,8.54 C 10.45,8.62 10.49,8.70 10.53,8.74 C 10.57,8.78 10.65,8.82 10.73,8.82 L 17.60,8.82 C 17.72,8.82 17.86,8.68 17.88,8.54";let Na=class extends se{constructor(){super(...arguments),this._device=null,this._loading=!0,this._error=null,this._triggers=[],this._receivers=[],this._hasReceivers=!0,this._filter="all",this._search="",this._bloomIds=new Set,this._assignSignal=null,this._assignedPopover=null,this._triggerDialog=null,this._triggerEditDialog=null,this._triggerPopover=null,this._confirmDeleteTriggerId=null,this._deleteSignal=null,this._editSignal=null,this._testDialog=null,this._testEmitters=[],this._testingSignalId=null,this._testResult=null,this._unsubSignals=null,this._unsubUpdated=null,this._refreshTimer=null,this._onDocClickForPopover=e=>{const i=e.composedPath(),t=this.shadowRoot?.querySelector("ir-trigger-popover"),a=this.shadowRoot?.querySelector("ir-assigned-popover");t&&i.includes(t)||a&&i.includes(a)||(this._closeTriggerPopover(),this._closeAssignedPopover())},this._onScrollForPopover=()=>{this._closeTriggerPopover(),this._closeAssignedPopover()}}connectedCallback(){super.connectedCallback(),this._load(),this._subscribe()}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe(),this._removePopoverDismiss(),null!==this._refreshTimer&&(clearTimeout(this._refreshTimer),this._refreshTimer=null)}async _load(){this._loading=!0;try{const[e,i,t]=await Promise.all([this.api.getUnknownDevices({source:"echo",min_hits:0}),this.api.listTriggers(),this.api.getSnifferStatus()]);this._triggers=i,this._hasReceivers=t.has_receivers;const a=e.find(e=>e.fingerprint===fa);this._device=a?await this.api.getUnknownDevice(a.id):null,this._error=null,this.api.listReceivers().then(e=>{this._receivers=e}).catch(()=>{this._receivers=[]})}catch(e){this._error=`Failed to load: ${e.message}`}finally{this._loading=!1}}async _refreshDevice(){if(this._device)try{this._device=await this.api.getUnknownDevice(this._device.id)}catch{await this._load()}else await this._load()}async _subscribe(){try{this._unsubSignals=await this.api.subscribeUnknownSignals(e=>this._onLiveSignal(e))}catch{}try{this._unsubUpdated=await this.api.subscribeSignalUpdated(()=>{this._refreshDots()})}catch{}}async _unsubscribe(){this._unsubSignals&&(await this._unsubSignals(),this._unsubSignals=null),this._unsubUpdated&&(await this._unsubUpdated(),this._unsubUpdated=null)}async _refreshDots(){try{this._triggers=await this.api.listTriggers()}catch{}await this._refreshDevice()}_onLiveSignal(e){e.device_fingerprint===fa&&(this._bloomIds=new Set([...this._bloomIds,e.signal_id]),setTimeout(()=>{const i=new Set(this._bloomIds);i.delete(e.signal_id),this._bloomIds=i},2500),null!==this._refreshTimer&&clearTimeout(this._refreshTimer),this._refreshTimer=window.setTimeout(()=>{this._refreshTimer=null,this._refreshDevice()},300))}_friendlyReceiver(e){const i=this._receivers.find(i=>i.entity_id===e);if(i?.name)return i.name;const t=this.hass?.states?.[e];return t?.attributes?.friendly_name??e}_receiverArea(e){const i=this.hass?.entities?.[e],t=i?.area_id??(i?.device_id?this.hass?.devices?.[i.device_id]?.area_id:null);return t?this.hass?.areas?.[t]?.name??null:null}_decodedDisplay(e){const i=e.decoded_fingerprint;if(!i)return null;const t=i.split(":");return t.length>=3?`${t[0]} ${t[1]} : ${t.slice(2).join(":")}`:i}_rowView(e){const i=e.echo_source??"",t=i.indexOf(" -- via "),a=t>=0?i.slice(0,t):i,o=t>=0?i.slice(t+8):"",r=o?o.split(", "):[];let n,s=null;const l=["Manual test send","Catalog test"].find(e=>a.startsWith(e)),d=a.startsWith("Fitting send")?"Fitting send":void 0;"automation send"===a?n=ke("mirror.chip_automation"):"integration send"===a?n=ke("mirror.chip_integration"):d?(n=ke("mirror.chip_fitting"),s=a.slice(d.length).replace(/^:\s*/,"").trim()||null):l?(n=ke("mirror.chip_test"),s=a.slice(l.length).replace(/^:\s*/,"").trim()||null):a?(n=ke("mirror.chip_device"),s=a):n=ke("mirror.chip_send");const c=(e.fingerprint??"").startsWith("mirror-unknown::"),p=(c&&"Unknown send"===e.alias?"":e.alias)||s||this._decodedDisplay(e)||(e.sl_pattern?[...e.sl_pattern].map(e=>"L"===e?"◆":"◇").join(""):null)||ke("mirror.unknown_title"),g=e.decoded_protocol??e.protocol,m=!e.decoded_protocol,u=r.length>2?ke("mirror.via_n",{count:r.length}):o?ke("mirror.via",{name:o}):"";let h=null,_=!1;if(this._hasReceivers){const i=e.heard_by??[];if(0===i.length)h=ke("mirror.not_heard");else{_=!0;const e=i.map(e=>this._receiverArea(e));if(e.every(e=>null!==e))h=ke("mirror.heard_in",{areas:[...new Set(e)].join(", ")});else{const e=i.map(e=>this._friendlyReceiver(e));h=ke("mirror.heard_by",{names:e.join(", ")})}}}return{sig:e,title:p,pill:g??null,pillRaw:m,via:u,viaFull:o,emitters:r,chip:n,heard:h,heardOk:_,unknownSend:c}}_rows(){const e=[...this._device?.signals??[]].sort((e,i)=>(i.last_seen??"").localeCompare(e.last_seen??""));return e.map(e=>this._rowView(e))}_filteredRows(e){let i=e;"notheard"===this._filter?i=i.filter(e=>0===(e.sig.heard_by??[]).length):"all"!==this._filter&&(i=i.filter(e=>e.emitters.includes(this._filter)));const t=this._search.trim().toLowerCase();return t&&(i=i.filter(e=>[e.title,e.pill??"",e.viaFull,e.chip,e.sig.decoded_fingerprint??"",e.sig.alias??""].join(" ").toLowerCase().includes(t))),i}_triggerCountFor(e){return this._triggers.filter(i=>ba(i,e)).length}_onAssignClick(e,i){if(!this._device)return;if(!e.assigned_to?.length)return void(this._assignSignal={signal:e,initialMode:"existing"});const t=i?.currentTarget,a=t?.getBoundingClientRect();this._assignedPopover={signal:e,top:a?a.bottom+4:120,left:a?Math.max(8,a.right-220):120},this._installPopoverDismiss()}_closeAssignedPopover(){this._assignedPopover=null,this._removePopoverDismiss()}_onAssignedPopoverCreateNew(){const e=this._assignedPopover;this._closeAssignedPopover(),e&&(this._assignSignal={signal:e.signal,initialMode:"existing"})}_onAssignedPopoverOpen(e){const i=e.detail;this._closeAssignedPopover(),i&&this.dispatchEvent(new CustomEvent("navigate-device",{detail:i.device_id,bubbles:!0,composed:!0}))}async _onSignalAssigned(e){this._assignSignal=null,await this._refreshDots()}_openTriggerDialog(e,i){const t=this._triggers.filter(i=>ba(i,e));if(0===t.length)return void(this._triggerDialog=e);const a=i?.currentTarget,o=a?.getBoundingClientRect();this._triggerPopover={signal:e,top:o?o.bottom+4:120,left:o?Math.max(8,o.right-220):120},this._installPopoverDismiss()}_closeTriggerPopover(){this._triggerPopover=null,this._removePopoverDismiss()}_onPopoverCreateNew(){const e=this._triggerPopover;this._closeTriggerPopover(),e&&(this._triggerDialog=e.signal)}_onPopoverEditTrigger(e){const i=e.detail;this._closeTriggerPopover(),i&&(this._triggerEditDialog=i)}async _onTriggerSaved(){this._triggerDialog=null,this._triggerEditDialog=null;try{this._triggers=await this.api.listTriggers()}catch{}}_closeTriggerDialog(){this._triggerDialog=null,this._triggerEditDialog=null}_requestDeleteTrigger(e){this._closeTriggerDialog(),this._confirmDeleteTriggerId=e}async _confirmDeleteTrigger(){const e=this._confirmDeleteTriggerId;if(this._confirmDeleteTriggerId=null,e)try{await this.api.deleteTrigger(e),this._triggers=await this.api.listTriggers()}catch(e){this._error=ke("common.delete_failed",{message:e.message})}}_installPopoverDismiss(){setTimeout(()=>{document.addEventListener("click",this._onDocClickForPopover,!0),window.addEventListener("scroll",this._onScrollForPopover,!0)},0)}_removePopoverDismiss(){document.removeEventListener("click",this._onDocClickForPopover,!0),window.removeEventListener("scroll",this._onScrollForPopover,!0)}async _sendTest(e){if(!this._testDialog)return;const i=this._testDialog,t=e.detail.emitters;if(0!==t.length){this._testingSignalId=i.id,this._testResult=null,this._testDialog=null;try{const e=(await Promise.allSettled(t.map(e=>this.api.testSignal(i.id,e)))).filter(e=>"fulfilled"===e.status&&e.value.sent).length,a=t.length;this._testResult=e===a?1===a?ke("mirror.sent"):ke("mirror.sent_all_n",{sent:e,total:a}):0===e?ke("mirror.failed"):ke("mirror.sent_partial",{sent:e,total:a})}catch{this._testResult=ke("mirror.error")}setTimeout(()=>{this._testResult=null,this._testingSignalId=null},3e3)}}async _onSignalEdited(){this._editSignal=null,await this._refreshDevice()}async _confirmDeleteSignal(){const e=this._deleteSignal;if(this._deleteSignal=null,e&&this._device)try{await this.api.deleteSignal(this._device.id,e.id),await this._refreshDevice()}catch(e){this._error=ke("common.delete_failed",{message:e.message})}}render(){const e=this._rows(),i=this._filteredRows(e);return B`
        ...
        `}_renderStats(e){const i=e.filter(e=>0===(e.sig.heard_by??[]).length).length,t=new Set;for(const i of e)i.emitters.forEach(e=>t.add(e));const a=this._device?.last_seen;return B`
            <div class="stats">
                ...
                <span class="updated">
                    ${this._hasReceivers?a?ja(a)===ke("rel.just_now")?ke("mirror.last_send_just"):ke("mirror.last_send_ago",{rel:ja(a)}):"":ke("mirror.no_receivers")}
                </span>
            </div>
        ...
        `}_renderRow(e){const i=e.sig,t=this._bloomIds.has(i.id),a=!!i.code,o=this._testingSignalId===i.id;return B`
            <div class="mrow ${t?"bloom":""}">
                ...
                <div class="mrow-meta">
                    <span class="counts"
                        >${i.hit_count}
                        ${1===i.hit_count?"send":"sends"}${i.last_seen?B` &middot; ${ja(i.last_seen)}`:""}</span
                    >
                    ${i.code?B`
                              <button
                                  class="code-btn"
                    ...
                    >${o?this._testResult??ke("mirror.sending"):ke("mirror.test")}</button>
                    <button
                        class="action-btn trigger-btn"
                        ?disabled=${!a}
        ...
        `],e([pe({attribute:!1})],Na.prototype,"api",void 0),e([pe({attribute:!1})],Na.prototype,"hass",void 0),e([ge()],Na.prototype,"_device",void 0),e([ge()],Na.prototype,"_loading",void 0),e([ge()],Na.prototype,"_error",void 0),e([ge()],Na.prototype,"_triggers",void 0),e([ge()],Na.prototype,"_receivers",void 0),e([ge()],Na.prototype,"_hasReceivers",void 0),e([ge()],Na.prototype,"_filter",void 0),e([ge()],Na.prototype,"_search",void 0),e([ge()],Na.prototype,"_bloomIds",void 0),e([ge()],Na.prototype,"_assignSignal",void 0),e([ge()],Na.prototype,"_assignedPopover",void 0),e([ge()],Na.prototype,"_triggerDialog",void 0),e([ge()],Na.prototype,"_triggerEditDialog",void 0),e([ge()],Na.prototype,"_triggerPopover",void 0),e([ge()],Na.prototype,"_confirmDeleteTriggerId",void 0),e([ge()],Na.prototype,"_deleteSignal",void 0),e([ge()],Na.prototype,"_editSignal",void 0),e([ge()],Na.prototype,"_testDialog",void 0),e([ge()],Na.prototype,"_testEmitters",void 0),e([ge()],Na.prototype,"_testingSignalId",void 0),e([ge()],Na.prototype,"_testResult",void 0),Na=e([ue("ir-mirror")],Na);const Ha=["tv","soundbar","receiver","settopbox","projector","fan","light","candles","ac","heater","blinds"];function La(e){const i=new Map;return e.rows.forEach((e,t)=>{e.failed?i.set(t,"failed"):e.confirmed&&i.set(t,"worked")}),i}let Va=class extends se{constructor(){super(...arguments),this._fit=null,this._order=[],this._verdicts=new Map,this._facts=new Map,this._emitter="",this._sendTimes=1,this._receiverIds=new Set,this._view="session",this._confirmDiscard=!1,this._busy=!1,this._error=null,this._handle="",this._github="",this._note="",this._kind="",this._replaceRow=null,this._replaceText="",this._replaceQuality=null,this._replaceBusy=!1,this._replaceError=null,this._listening=!1,this._listenMissed=!1,this._revertArmed=null,this._notice=null,this._unlisten=null,this._scrollToKey=null}connectedCallback(){super.connectedCallback(),this._load()}disconnectedCallback(){super.disconnectedCallback(),this._stopListening()}async _load(){try{const[e,i]=await Promise.all([this.api.fittingState(this.wig.filename),this.api.listReceivers().catch(()=>[])]);this._receiverIds=new Set(i.map(e=>e.entity_id)),this._fit=e,this._handle=e.username,this._kind=e.kind??"",e.send_times&&(this._sendTimes=Math.max(1,Math.min(e.send_times,10)));const t=e.ledger.find(i=>i.github&&i.handle.toLowerCase()===e.username.toLowerCase());this._github=function(e){let i=e.trim();i=i.replace(/^https?:\/\/(www\.)?github\.com\//i,""),i=i.replace(/^@+/,"");const t=i.indexOf("/");return-1!==t&&(i=i.slice(0,t)),i.trim()}(t?.github??"");const a=La(e);this._verdicts=a;const o=e.signals.map((e,i)=>i);this._order=e.matrix?o:[...o.filter(e=>!a.has(e)),...o.filter(e=>a.has(e))];const r=this._emitters();1===r.length&&(this._emitter=r[0].id)}catch(e){this._error=e?.message??String(e)}}_emitters(){const e=this.hass?.states??{},i=[];for(const[t,a]of Object.entries(e))!t.startsWith("infrared.")||this._receiverIds.has(t)||a.attributes?.hair_observer||i.push({id:t,name:a.attributes?.friendly_name??t});return i}_close(){this.dispatchEvent(new CustomEvent("closed",{bubbles:!0,composed:!0}))}_onSendTimesInput(e){const i=Number(e.target.value);Number.isFinite(i)&&(this._sendTimes=Math.max(1,Math.min(Math.round(i),10)))}async _send(e){if(!this._emitter||!this._fit)return;const i=this._facts.get(e)??{sent:0,heard:!1,busy:!1};if(!i.busy){this._facts=new Map(this._facts).set(e,{...i,busy:!0});try{const t=await this.api.fittingSend(this.wig.filename,e,this._emitter,this._sendTimes);this._facts=new Map(this._facts).set(e,{sent:i.sent+1,heard:i.heard||t.heard,busy:!1})}catch(t){this._facts=new Map(this._facts).set(e,{...i,busy:!1}),this._error=t?.message??String(t)}}}async _mark(e,i){const t=this._verdicts.get(e)===i?"untested":i,a=new Map(this._verdicts);"untested"===t?a.delete(e):a.set(e,t),this._verdicts=a;try{await this.api.fittingMark(this.wig.filename,e,t)}catch(e){this._error=e?.message??String(e)}}async _refresh(){const e=await this.api.fittingState(this.wig.filename);if(this._fit=e,this._verdicts=La(e),e.rows.length!==this._order.length){const i=new Set(this._order);this._order=[...this._order.filter(i=>i<e.rows.length),...e.rows.map((e,i)=>i).filter(e=>!i.has(e))]}}async _stopListening(){const e=this._unlisten;if(this._unlisten=null,this._listening=!1,e)try{await e()}catch{}}async _openReplace(e){this._replaceRow!==e?(await this._stopListening(),this._revertArmed=null,this._replaceRow=e,this._replaceText="",this._replaceQuality=null,this._replaceError=null,this._listenMissed=!1,this._notice=null):await this._closeReplace()}async _closeReplace(){await this._stopListening(),this._replaceRow=null,this._replaceText="",this._replaceQuality=null,this._replaceError=null,this._listenMissed=!1}_onReplaceInput(e){this._replaceText=e.target.value,this._replaceQuality=null,this._listenMissed=!1}async _listen(){if(this._listening)await this._stopListening();else{this._replaceError=null,this._listenMissed=!1,this._listening=!0;try{this._unlisten=await this.api.fittingListen(e=>{"fitting_capture"===e.type?(this._replaceText=e.pronto,this._replaceQuality={decoded:e.decoded,protocol:e.protocol,receiver:e.receiver},this._stopListening()):(this._listenMissed=!0,this._stopListening())})}catch(e){this._listening=!1,this._replaceError=e?.message??String(e)}}}async _confirmReplace(){const e=this._replaceRow;if(null===e||!this._replaceText.trim())return;this._replaceBusy=!0,this._replaceError=null;const i=this._replaceQuality?"captured":"pasted";try{const t=await this.api.fittingReplace(this.wig.filename,e,this._replaceText.trim(),i);await this._closeReplace(),await this._refresh(),this._notice=t.carried>0?ke("fitting.replaced_notice",{count:String(t.carried)}):ke("fitting.replaced_notice_none"),this._recordedRefresh()}catch(e){this._replaceError=e?.message??String(e)}this._replaceBusy=!1}_navigateToFailed(e){this._scrollToKey=e[0]??null,this._view="session"}updated(){if(!this._scrollToKey||"session"!==this._view)return;const e=this._scrollToKey;this._scrollToKey=null;const i=this._fit?.rows.findIndex(i=>i.key===e)??-1;i<0||this.renderRoot?.querySelector(`[data-row-index="${i}"]`)?.scrollIntoView({block:"center"})}async _discard(){this._busy=!0;try{await this.api.fittingDiscard(this.wig.filename)}catch{}this._busy=!1,this._recordedRefresh(),this._close()}async _record(){this._busy=!0,this._error=null;try{const e=await this.api.fittingFinish(this.wig.filename,{...this._handle.trim()?{handle:this._handle.trim()}:{},...this._github.trim()?{github:this._github.trim()}:{},...this._note.trim()?{note:this._note.trim()}:{},...this._kind.trim()&&!this._fit?.kind?{kind:this._kind.trim()}:{}});this.dispatchEvent(new CustomEvent("recorded",{detail:e,bubbles:!0,composed:!0})),this._close()}catch(e){this._error=e?.message??String(e)}this._busy=!1}_recordedRefresh(){this.dispatchEvent(new CustomEvent("recorded",{detail:null,bubbles:!0,composed:!0}))}get _counts(){let e=0,i=0;for(const t of this._verdicts.values())"worked"===t?e+=1:i+=1;const t=this._fit?.signals.length??0;return{worked:e,failed:i,tested:e+i,total:t,perfect:t>0&&e===t}}render(){return B`
            <div class="overlay" @click=${this._close}>
                <div
                    class="dialog fit-dialog"
                    @click=${e=>e.stopPropagation()}
                >
                    ${"sign"===this._view?this._renderSign():"ledger"===this._view?this._renderLedger():this._renderSession()}
                </div>
            </div>
        `}_ledgerSplit(){const e=(this._fit?.username??"").trim().toLowerCase(),i=this._fit?.ledger??[],t=i.find(i=>i.valid&&i.handle.trim().toLowerCase()===e),a=i.filter(e=>e!==t);return{mine:t,others:a}}_chipDate(e){if(!e)return"";const i=new Date(`${e}T00:00:00`);return Number.isNaN(i.getTime())?e:i.toLocaleDateString(void 0,{month:"short",day:"numeric"})}_renderFitChips(){const{mine:e,others:i}=this._ledgerSplit();if(!e&&0===i.length)return U;const t=this._fit?.signals.length??0;return B`
            <div class="fitrow">
                ${e?B`<button
                          class="fstat you ${e.complete?"":"partial"}"
                          @click=${()=>this._view="ledger"}
                      >
                          <span class="tick">&check;</span>
                          ${e.complete?ke("fitting.chip_you",{date:this._chipDate(e.date)}):ke("fitting.chip_you_partial",{confirmed:String(e.confirmed),total:String(t)})}
                      </button>`:U}
                ${i.length?B`<button
                          class="fstat others"
                          @click=${()=>this._view="ledger"}
                      >
                          ${$e("fitting.chip_others",i.length)}
                      </button>`:U}
            </div>
        `}_renderSession(){const e=this._counts;return B`
            <h3 class="heading">${this.wig.name}</h3>
            ${this._fit?.matrix?B`<div class="matrix-claim">
                      ${ke("fitting.matrix_claim",{sends:String(this._fit.rows.length),cells:String(this.wig.matrix?.cells??this._fit.rows.length)})}
                  </div>`:U}
            <div class="sess-head">${ke("fitting.header")}</div>
            ${this._renderFitChips()}
            ${this._error?B`<div class="err">${this._error}</div>`:U}
            ${this._notice?B`<div class="notice">${this._notice}</div>`:this._fit?.carried?B`<div class="notice">
                        ${ke("fitting.carried_notice")}
                    </div>`:U}
            <div class="field">
                <label>${ke("fitting.emitter")}</label>
                <select
                    .value=${this._emitter}
                    @change=${e=>this._emitter=e.target.value}
                >
                    <option value="" ?selected=${!this._emitter}>
                        ${ke("fitting.pick_emitter")}
                    </option>
                    ${this._emitters().map(e=>B`<option
                            value=${e.id}
                            ?selected=${e.id===this._emitter}
                        >
                            ${e.name}
                        </option>`)}
                </select>
            ...
            <div class="field">
                <label>${ke("fitting.send_times")}</label>
                <input
                    class="send-count"
                    type="number"
                    min="1"
                ...
                />
                <div class="hint">${ke("fitting.send_times_hint")}</div>
            </div>
            <div class="sig-list">
                ${this._fit?this._fit.matrix?this._renderMatrixList():this._order.map(e=>this._renderRow(e)):B`<div class="loading">
                          ${ke("common.loading_plain")}
                      </div>`}
            </div>
            <div class="progress-line ${e.perfect?"perfect":""}">
                <span>
                    ${e.perfect?ke("fitting.all_worked",{count:String(e.total)}):B`${ke("fitting.progress",{tested:String(e.tested),total:String(e.total)})}${e.failed>0?B` &middot;
                                    <span class="fail-note"
                                        >${$e("fitting.failed",e.failed)}</span
                                    >`:U}`}
                </span>
                <span class="bar"
                    ><i
                        style="width:${e.total?Math.round(e.tested/e.total*100):0}%"
                    ></i
                ></span>
            </div>
            <div class="dialog-actions fit-actions">
                ${this._confirmDiscard?B`
                          <span class="discard-q"
                              >${ke("fitting.discard_confirm")}${this._fit?.pending_replaces?B` <span class="discard-revert"
                                        >${$e("fitting.discard_reverts",this._fit.pending_replaces)}</span
                                    >`:U}</span
                          >
                          <span class="spacer"></span>
                          <button
                              class="action-btn cancel-btn"
                              @click=${()=>this._confirmDiscard=!1}
                          >
                              ${ke("fitting.keep")}
                          </button>
                          <button
                      ...
                      `:B`
                          ...
                          <button
                              ...
                              ?disabled=${0===e.tested&&!this._fit?.pending_replaces}
                              @click=${()=>this._confirmDiscard=!0}
                          >
                              ${ke("fitting.discard")}
                          </button>
                          <button
                              class="action-btn finish-btn ${e.perfect?"green":""}"
                              ?disabled=${0===e.tested}
            ...
            <div class="hint">${ke("fitting.close_hint")}</div>
        `}_renderRow(e){const i=this._fit.signals[e];return B`
            <div class="sig-row" data-row-index=${e}>
                <span class="sig-alias" title=${i}>${i}</span>
                ${this._renderChip(e)} ${this._renderRowControls(e)}
            </div>
            ${this._renderReplaceStrip(e)}
        `}_renderChip(e){const i=this._fit?.rows[e],t=i?.provenance;if(!t)return U;const a=ke("captured"===t.replaced?"fitting.chip_replaced_captured":"fitting.chip_replaced_pasted");if(!i?.revertible)return B`<span class="prov-chip" title=${t.date??""}
                >${a}</span
            >`;const o=this._revertArmed===e;return B`<button
            class="prov-chip revertible ${o?"armed":""}"
            title=${ke("fitting.revert_title")}
            @click=${()=>{this._onChipClick(e)}}
        >
            <span class="chip-label">${a}</span>
            <span class="chip-alt"
                >${ke(o?"fitting.revert_confirm":"fitting.revert")}</span
            >
        </button>`}async _onChipClick(e){if(this._revertArmed===e){this._revertArmed=null,this._replaceBusy=!0,this._error=null;try{const i=await this.api.fittingRevert(this.wig.filename,e);await this._closeReplace(),await this._refresh(),this._notice=ke("fitting.reverted_notice",{count:String(i.carried)}),this._recordedRefresh()}catch(e){this._error=e?.message??String(e)}this._replaceBusy=!1}else this._revertArmed=e}_renderRowControls(e){const i=this._verdicts.get(e),t=this._facts.get(e);return B`${t?.sent?B`<span class="facts">
                      ${t.sent>1?ke("fitting.sent_n",{count:String(t.sent)}):ke("fitting.sent")}${t.heard?B` &middot;
                                <span class="heard"
                                    >${ke("fitting.heard")}</span
                                >`:U}
                  </span>`:U}
            <button
                class="send-btn"
                ?disabled=${!this._emitter||t?.busy}
                title=${this._emitter?"":ke("fitting.pick_emitter")}
                @click=${()=>{this._send(e)}}
            >
                ${ke("fitting.send")}
            </button>
            <button
                class="vbtn ${"worked"===i?"worked-on":""}"
                @click=${()=>{this._mark(e,"worked")}}
            >
                ${ke("fitting.worked")}
            </button>
            <button
                class="vbtn ${"failed"===i?"failed-on":""}"
                @click=${()=>{this._mark(e,"failed")}}
            >
                ${ke("fitting.did_not")}
            </button>
            <button
                class="vbtn replace-btn ${this._replaceRow===e?"open":""}"
                title=${ke("fitting.replace_title")}
                @click=${()=>{this._openReplace(e)}}
            >
                ${ke("fitting.replace")}
            </button>`}_rowStateInstruction(e){const i=this._fit?.rows[e];if(!i||!this._fit?.matrix)return"";if("start"===i.section)return ke("fitting.row_on");if("wrap"===i.section)return ke("fitting.row_off");const t=[];return i.mode&&t.push(i.mode),i.fan&&t.push(ke("fitting.ctx_fan",{fan:i.fan})),i.swing&&t.push(ke("fitting.ctx_swing",{swing:i.swing})),null!=i.temp&&t.push(`${this._displayTemp(i.temp)}°`),t.join(" · ")}_renderQualityLine(e){if(this._listening){const i=this._rowStateInstruction(e);return B`<div class="qline listen">
                <span class="pulse"></span>
                <span
                    >${i?ke("fitting.listening_state",{state:i}):ke("fitting.listening")}</span
                >
            </div>`}if(this._listenMissed)return B`<div class="qline warn">
                ${ke("fitting.listen_missed")}
            </div>`;const i=this._replaceQuality;return i?i.decoded?B`<div class="qline good">
            &check;
            <span
                >${i.receiver?ke("fitting.capture_clean_via",{receiver:this._receiverName(i.receiver)}):ke("fitting.capture_clean")}${i.protocol?` · ${i.protocol}`:""}</span
            >
        </div>`:B`<div class="qline warn">
                ${ke("fitting.capture_rough")}
            </div>`:U}_receiverName(e){const i=this.hass?.states?.[e];return i?.attributes?.friendly_name??e}_renderReplaceStrip(e){if(this._replaceRow!==e)return U;const i=!!this._replaceQuality&&!this._replaceQuality.decoded,t=!!this._replaceText.trim()&&!this._replaceBusy;return B`
            <div class="repstrip">
                <div class="titleline">
                    <span class="t">${ke("fitting.replace_heading")}</span>
                    <span class="why">${ke("fitting.replace_why")}</span>
                </div>
                <textarea
                    class="prontobox"
                    spellcheck="false"
                ...
                ></textarea>
                ${this._renderQualityLine(e)}
                ${this._replaceError?B`<div class="qline bad">
                          ${this._replaceError}
                      </div>`:U}
                <div class="repactions">
                    <button
                        class="vbtn listen-btn ${this._listening?"on":""}"
                        @click=${()=>{this._listen()}}
                    >
                        ${this._listening?ke("fitting.listening_btn"):this._replaceQuality?ke("fitting.listen_again"):ke("fitting.listen")}
                    </button>
                    <span class="rep-hint"
                        >${ke("fitting.replace_hint")}</span
                    >
                    <button
                        class="vbtn"
                        @click=${()=>{this._closeReplace()}}
                    >
                        ${ke("common.cancel")}
                    </button>
                    <button
                        ...
                        ?disabled=${!t}
                        @click=${()=>{this._confirmReplace()}}
                    >
                        ${ke(i?"fitting.replace_anyway":"fitting.replace")}
                    </button>
                </div>
            </div>
        `}_renderMatrixList(){const e=this._fit.rows,i=[];let t=null;return e.forEach((e,a)=>{e.section!==t&&(t=e.section,i.push(this._renderSectionHead(e))),i.push(this._renderMatrixRow(a))}),i}_displayTemp(e){return ia(e,this._fit?.unit??"C",ea(this.hass),this._fit?.precision??1)}_sectionNote(e){if("modes"===e.section)return ke("fitting.sec_modes_note");if("changed"===e.section)return ke("fitting.sec_changed_note");if("fan"!==e.section&&"swing"!==e.section&&"temp"!==e.section)return"";const i=[];if(e.mode){const t="temp"===e.section?null:e.temp;i.push(null!=t?`${e.mode} ${this._displayTemp(t)}`:e.mode)}return"fan"!==e.section&&null!=e.fan&&i.push(ke("fitting.ctx_fan",{fan:e.fan})),"swing"!==e.section&&null!=e.swing&&i.push(ke("fitting.ctx_swing",{swing:e.swing})),0===i.length?"":ke("fitting.sec_in",{context:i.join(", ")})}_renderSectionHead(e){const i=this._sectionNote(e);return B`
            <div class="sec-head">
                <span>${ke(`fitting.sec_${e.section}`)}</span>
                ${i?B`<span class="sec-note">${i}</span>`:U}
            </div>
        `}_renderMatrixRow(e){const i=this._fit.rows[e];let t=i.key,a=!1,o="";return"start"===i.section?(t=ke("fitting.row_on"),a=!0):"wrap"===i.section?(t=ke("fitting.row_off"),a=!0):"modes"===i.section?(t=i.mode??i.key,a=!0,o=[i.fan,null!=i.temp?`${this._displayTemp(i.temp)}°`:null].filter(Boolean).join(" · "),i.temp_less&&(o=[o,ke("fitting.no_temp_note")].filter(Boolean).join(" "))):"fan"===i.section?t=i.fan??i.key:"swing"===i.section?t=i.swing??i.key:"temp"===i.section?t=ke("min"===i.temp_role?"fitting.temp_min":"fitting.temp_max",{temp:null!=i.temp?this._displayTemp(i.temp):""}):"changed"===i.section&&(t=i.mode??i.key,a=!0,o=[i.fan,i.swing,null!=i.temp?`${this._displayTemp(i.temp)}°`:null].filter(Boolean).join(" · ")),B`
            <div class="sig-row" data-row-index=${e}>
                <span
                    class="sig-alias ${a?"caps":""}"
                    title=${i.key}
                    >${t}${o?B` <span class="row-dim">${o}</span>`:U}</span
                >
                ${this._renderChip(e)} ${this._renderRowControls(e)}
            </div>
            ${this._renderReplaceStrip(e)}
        `}_renderLedger(){const e=this._fit?.ledger??[],i=this._fit?.signals.length??0;return B`
            <h3 class="heading">${ke("fitting.ledger_heading")}</h3>
            <div class="ledger">
                ${e.map(e=>{const t=[];return e.hair_version&&t.push(`HAIR ${e.hair_version}`),e.emitter&&t.push(e.receiver?`${e.emitter} → ${e.receiver}`:e.emitter),t.push(ke("fitting.ledger_coverage",{confirmed:String(e.confirmed),total:String(i)})),e.signals_heard&&t.push(ke("fitting.ledger_heard",{count:String(e.signals_heard)})),e.send_times_used&&t.push(ke("fitting.ledger_send_times",{count:String(e.send_times_used)})),e.key_fingerprint&&t.push(`key ${e.key_fingerprint}`),B`
                        <div class="led-row">
                            <div class="led-head">
                                <span class="led-handle"
                                    >${e.handle}</span
                                >
                                ${e.github?B`<span class="led-gh"
                                          >@${e.github.replace(/^@/,"")}</span
                                      >`:U}
                                ${e.draft?B`<span
                                          class="led-sig unsigned"
                                          >${ke("fitting.ledger_in_progress")}</span
                                      >`:"valid"===e.signed?B`<span
                                            class="led-sig valid"
                                            >&check;
                                            ${ke("fitting.ledger_signed")}</span
                                        >`:"invalid"===e.signed?B`<span
                                              class="led-sig bad"
                                              >${ke("fitting.ledger_bad_sig")}</span
                                          >`:B`<span
                                              class="led-sig unsigned"
                                              >${ke("fitting.ledger_unsigned")}</span
                                          >`}
                                <span class="led-date"
                                    >${e.date??""}</span
                                >
                            ...
                            <div class="led-evidence">
                                ${t.join(" · ")}${e.failed?B` ·
                                          ${e.failed_keys?.length?B`<button
                                                    class="led-failed"
                                                    title=${ke("fitting.ledger_goto_failed")}
                                                    @click=${()=>this._navigateToFailed(e.failed_keys)}
                                                >
                                                    ${$e("fitting.failed",e.failed)}
                                                </button>`:B`<span class="fail-note"
                                                    >${$e("fitting.failed",e.failed)}</span
                                                >`}`:U}
                            </div>
                            ${e.valid?U:B`<div class="led-invalid">
                                      ${ke("fitting.ledger_invalid")}
                                  </div>`}
                            ${e.note?B`<div class="led-note">
                                      “${e.note}”
                                  </div>`:U}
                        </div>
                    `})}
        ...
        `}_renderSign(){const e=this._counts,i=this._emitters().find(e=>e.id===this._emitter)?.name??ke("fitting.your_emitter");return B`
            <h3 class="heading">${ke("fitting.sign_heading")}</h3>
            <div class="sign-line ${e.perfect?"perfect":""}">
                ${e.perfect?ke("fitting.sign_perfect",{count:String(e.total),emitter:i}):ke("fitting.sign_partial",{worked:String(e.worked),failed:String(e.failed),total:String(e.total),emitter:i})}
            </div>
            ${this._error?B`<div class="err">${this._error}</div>`:U}
            <div class="field">
                <label>${ke("fitting.handle")}</label>
                <input
                    .value=${this._handle}
                    @input=${e=>this._handle=e.target.value}
                />
            </div>
            <div class="field">
            ...
            ${this._fit?.kind?U:B`<div class="field">
                      <label>${ke("fitting.kind")}</label>
                      <input
                          list="kind-suggestions"
                          .value=${this._kind}
                          placeholder=${ke("fitting.kind_placeholder")}
                          @input=${e=>this._kind=e.target.value}
                      />
                      <datalist id="kind-suggestions">
                          ${Ha.map(e=>B`<option value=${e}></option>`)}
                      </datalist>
                      <div class="hint">${ke("fitting.kind_hint")}</div>
                  </div>`}
            <div class="field">
                <label>${ke("fitting.note")}</label>
                <input
                    .value=${this._note}
                    placeholder=${ke("fitting.note_placeholder")}
                    @input=${e=>this._note=e.target.value}
                />
            </div>
            <div class="hint">${ke("fitting.signed_hint")}</div>
            <div class="dialog-actions fit-actions">
                <button
                    class="action-btn cancel-btn"
                    @click=${()=>this._view="session"}
        ...
        `],e([pe({attribute:!1})],Va.prototype,"api",void 0),e([pe({attribute:!1})],Va.prototype,"hass",void 0),e([pe({attribute:!1})],Va.prototype,"wig",void 0),e([ge()],Va.prototype,"_fit",void 0),e([ge()],Va.prototype,"_order",void 0),e([ge()],Va.prototype,"_verdicts",void 0),e([ge()],Va.prototype,"_facts",void 0),e([ge()],Va.prototype,"_emitter",void 0),e([ge()],Va.prototype,"_sendTimes",void 0),e([ge()],Va.prototype,"_receiverIds",void 0),e([ge()],Va.prototype,"_view",void 0),e([ge()],Va.prototype,"_confirmDiscard",void 0),e([ge()],Va.prototype,"_busy",void 0),e([ge()],Va.prototype,"_error",void 0),e([ge()],Va.prototype,"_handle",void 0),e([ge()],Va.prototype,"_github",void 0),e([ge()],Va.prototype,"_note",void 0),e([ge()],Va.prototype,"_kind",void 0),e([ge()],Va.prototype,"_replaceRow",void 0),e([ge()],Va.prototype,"_replaceText",void 0),e([ge()],Va.prototype,"_replaceQuality",void 0),e([ge()],Va.prototype,"_replaceBusy",void 0),e([ge()],Va.prototype,"_replaceError",void 0),e([ge()],Va.prototype,"_listening",void 0),e([ge()],Va.prototype,"_listenMissed",void 0),e([ge()],Va.prototype,"_revertArmed",void 0),e([ge()],Va.prototype,"_notice",void 0),Va=e([ue("ir-fitting-dialog")],Va);const qa="_unbranded",Oa={wig:{label:"Wig",url:"https://github.com/DAB-LABS/WigShop"},smartir:{label:"SmartIR",url:"https://github.com/smartHomeHub/SmartIR"},flipper:{label:"Flipper",url:"https://github.com/logickworkshop/Flipper-IRDB"},lirc:{label:"LIRC",url:"https://lirc.sourceforge.net/remotes/"},girr:{label:"Girr",url:"https://www.harctoolbox.org/Girr.html"}},Ba=/\{(wig|smartir|flipper|lirc|girr)\}/g;let Fa=class extends se{constructor(){super(...arguments),this._loading=!0,this._error=null,this._wigs=[],this._invalid=[],this._library=[],this._libraryVersion=null,this._search="",this._filter="all",this._openBrands=new Set,this._dragOver=!1,this._notice=null,this._noticeKind="ok",this._receipt=null,this._receiptKind="ok",this._receiptFiles=[],this._receiptSuffix="",this._bloomId=null,this._pendingScrollId=null,this._busyId=null,this._fittingWig=null,this._adoptWig=null,this._adoptCodebook=null,this._linkedPopoverId=null,this._linkedPopoverPos={top:0,left:0},this._peekId=null,this._peekPos={top:0,left:0},this._peekNames=[],this._peekMatrix=null,this._clipConfirm=null,this._editing=null,this._editName="",this._editBrand="",this._editModel="",this._editKind="",this._editNotes="",this._editFccId="",this._editUpc="",this._editAsin="",this._editOem="",this._editBusy=!1,this._editError=null,this._confirmDelete=null}connectedCallback(){super.connectedCallback(),this._refresh()}disconnectedCallback(){super.disconnectedCallback(),this._noticeTimer&&window.clearTimeout(this._noticeTimer)}async _refresh(e=!1){this._loading=!e;try{const e=await this.api.wigsList();this._wigs=e.wigs,this._invalid=e.invalid,this._library=e.library,this._libraryVersion=e.library_version,this._error=null}catch(e){this._error=ke("wigs.load_failed",{message:e.message})}finally{this._loading=!1}}_flash(e,i="ok"){this._noticeKind=i,this._notice=e,this._noticeTimer&&window.clearTimeout(this._noticeTimer),this._noticeTimer=window.setTimeout(()=>{this._notice=null},5e3)}_brandKeyFor(e){return e&&e.trim()?e.trim().toLowerCase().replace(/\s+/g,"_"):qa}_brandRows(){const e=new Map;for(const i of this._library)e.set(i.brand,{key:i.brand,label:i.label,unbranded:i.brand===qa,rows:i.codebooks.filter(e=>"local"!==e.source).map(e=>({source:"library",id:e.id,label:e.label,signalCount:e.functions.length,signalNames:e.functions.map(e=>e.name)}))});for(const i of this._wigs){const t=this._brandKeyFor(i.brand);let a=e.get(t);a||(a={key:t,label:t===qa?ke("wigs.unbranded"):(i.brand??"").trim(),unbranded:t===qa,rows:[]},e.set(t,a)),a.rows.push({source:"local",id:`wig:${i.filename}`,label:i.name,signalCount:i.signal_count,signalNames:i.signals??[],wig:i})}const i=[...e.values()].filter(e=>e.rows.length>0);for(const e of i)e.rows.sort((e,i)=>e.label.toLowerCase().localeCompare(i.label.toLowerCase()));return i.sort((e,i)=>e.unbranded!==i.unbranded?e.unbranded?-1:1:e.label.toLowerCase().localeCompare(i.label.toLowerCase())),i}_visibleRows(e){let i=e.rows;"library"===this._filter?i=i.filter(e=>"library"===e.source):"yours"===this._filter?i=i.filter(e=>"local"===e.source):"fitted"===this._filter?i=i.filter(e=>e.wig?.fitting?.state):"unfitted"===this._filter&&(i=i.filter(e=>e.wig&&!e.wig.fitting?.state));const t=this._search.trim().toLowerCase();return t&&!e.label.toLowerCase().includes(t)&&(i=i.filter(e=>this._rowMatches(e,t))),i}_rowMatches(e,i){if(e.label.toLowerCase().includes(i))return!0;const t=e.wig;if(!t)return!1;if(t.kind?.toLowerCase().includes(i))return!0;for(const e of Object.values(t.identifiers??{}))if((Array.isArray(e)?e:[e]).some(e=>String(e).toLowerCase().includes(i)))return!0;return!1}_isOpen(e,i){return this._search.trim().toLowerCase()?i.length>0:this._openBrands.has(e.key)}_toggleBrand(e){const i=new Set(this._openBrands);i.has(e)?i.delete(e):i.add(e),this._openBrands=i}_togglePeek(e,i){if(i.stopPropagation(),this._peekId===e.id)return void(this._peekId=null);const t=i.currentTarget.getBoundingClientRect();this._peekPos={top:t.bottom+6,left:t.left},this._peekNames=e.signalNames,this._peekMatrix=e.wig?.matrix??null,this._peekId=e.id}_renderPeekTempRange(){const e=this._peekMatrix,i=ea(this.hass);return ke("wigs.peek.temp",{min:ia(e.min_temp,e.unit,i),max:ia(e.max_temp,e.unit,i),unit:i})}_renderPeek(){if(!this._peekId)return"";if(!this._peekMatrix&&0===this._peekNames.length)return"";const e=this._peekMatrix?B`<div class="peek-entry">
                      ${ke("wigs.peek.modes",{list:this._peekMatrix.modes.join(", ")})}
                  </div>
                  ${this._peekMatrix.fan_modes.length?B`<div class="peek-entry">
                            ${ke("wigs.peek.fans",{list:this._peekMatrix.fan_modes.join(", ")})}
                        </div>`:""}
                  ${this._peekMatrix.swing_modes.length?B`<div class="peek-entry">
                            ${ke("wigs.peek.swings",{list:this._peekMatrix.swing_modes.join(", ")})}
                        </div>`:""}
                  <div class="peek-entry">
                      ${this._renderPeekTempRange()}
                  </div>`:this._peekNames.map(e=>B`<div class="peek-entry">${e}</div>`);return B`<div
                class="linked-scrim"
            ...
            >
                ${e}
            </div>`}async _tryOn(e,i=!1){this._busyId=e.id;try{const t=await this.api.importCodeRemote(e.id,void 0,i);if(i){const e=t.duplicates??0;this._flash(e>0?ke("wigs.clip_matrix_done_duplicates",{imported:String(t.imported),duplicates:String(e)}):ke("wigs.clip_matrix_done",{imported:String(t.imported)}))}else this._flash(ke("wigs.tried_on",{name:t.device.label??e.label}));this.dispatchEvent(new CustomEvent("wig-tried-on",{detail:t.device,bubbles:!0,composed:!0}))}catch(e){this._flash(ke("wigs.try_on_failed",{message:e.message}),"warn")}finally{this._busyId=null}}_clipCount(e){const i=e.wig?.matrix;return i?i.cells+1+(i.has_on?1:0)+e.signalCount:e.signalCount}_onClipClick(e){e.wig?.matrix?this._clipConfirm=e:this._tryOn(e)}_renderClipConfirm(){const e=this._clipConfirm;if(!e)return"";const i=this._clipCount(e),t=ke("wigs.clip_matrix_confirm",{count:String(i)})+(i>500?` ${ke("wigs.clip_matrix_slow")}`:"");return B`<ir-confirm-dialog
            title=${e.label}
            message=${t}
            confirmLabel=${ke("wigs.clip_it")}
            @confirmed=${()=>{const e=this._clipConfirm;this._clipConfirm=null,this._tryOn(e,!0)}}
            @closed=${()=>this._clipConfirm=null}
        ></ir-confirm-dialog>`}async _uploadText(e,i=""){try{const t=await this.api.wigsUpload(e,i);if(!t.success)return this._receiptKind="warn",this._receiptFiles=[],void(this._receipt=ke("wigs.upload_failed",{reason:(t.errors??[]).join("; ")}));const a=t.files??[],o=a.some(e=>e.duplicate_of);this._receiptFiles=a,this._receiptSuffix=(t.skipped??[]).length>0?ke("wigs.upload_partial",{count:String(t.skipped.length)}):"",this._receiptKind=o?"dup":"ok",this._receipt="files","library"===this._filter&&(this._filter="all"),await this._refresh()}catch(e){this._receiptKind="warn",this._receiptFiles=[],this._receipt=ke("wigs.upload_failed",{reason:e.message})}}_renderReceiptLine(){if(0===this._receiptFiles.length)return B`${this._receipt}`;const e=this._receiptFiles.map(e=>{const i=e.brand?.trim()||ke("wigs.unbranded"),t=e.duplicates??[],a=ke(e.duplicate_of?"wigs.receipt.duplicate":"wigs.receipt.hung",{name:"",brand:"",brands:""}),o=t.map((e,i)=>B`${i>0?", ":""}<button
                        class="receipt-link"
                        @click=${()=>this._jumpToWig({filename:e.filename,brand:e.brand})}
                    >${e.brand?.trim()||ke("wigs.unbranded")}</button>`),r=a.split(/([\u0001\u0002\u0003])/);return B`${r.map(t=>""===t?B`<button
                          class="receipt-link"
                          @click=${()=>this._jumpToWig(e)}
                      >${e.name}</button>`:""===t?B`<button
                            class="receipt-link"
                            @click=${()=>this._jumpToBrand(e)}
                        >${i}</button>`:""===t?B`${o}`:B`${t}`)}`});return B`${e.map((e,i)=>B`${i>0?B` \u00b7 `:""}${e}`)}${this._receiptSuffix?B` \u00b7 ${this._receiptSuffix}`:""}`}_renderDropTitle(){const e=ke("wigs.drop.title").split(Ba);return B`${e.map((e,i)=>{const t=i%2==1?Oa[e]:void 0;return t?B`<a
                      class="fmt-link"
                      href=${t.url}
                      target="_blank"
                      rel="noopener"
            ...
            >
                <div class="popover-header">
                    ${$e("wigs.linked",i.length)}
                </div>
                <button
                    class="popover-item accent"
                    @click=${i=>{i.stopPropagation(),this._linkedPopoverId=null,this._adoptWig=e}}
                >
                    <span>${ke("wigs.linked_new")}</span>
                </button>
                <div class="popover-divider"></div>
                ${i.map(e=>B`<button
                        class="popover-item"
                        @click=${i=>{i.stopPropagation(),this._linkedPopoverId=null,this.dispatchEvent(new CustomEvent("navigate-device",{detail:e.device_id,bubbles:!0,composed:!0}))}}
                    >
                        <span class="popover-name"
                            >${e.device_name}</span
                        >
            ...
            </div>`:""}_kindSuggestions(){const e=["tv","soundbar","receiver","settopbox","projector","fan","light","candles","ac","heater","blinds"],i=new Set(e);for(const t of this._wigs)t.kind&&!i.has(t.kind)&&(i.add(t.kind),e.push(t.kind));return e}_originSentence(e){return e?e.startsWith("converted")?ke("wigs.origin.converted",{format:e.split(":")[1]??"another format"}):e.startsWith("plucked")?ke("wigs.origin.plucked"):{captured:ke("wigs.origin.captured"),clipped:ke("wigs.origin.clipped"),device:ke("wigs.origin.device"),library:ke("wigs.origin.library")}[e]??ke("wigs.origin.unknown"):ke("wigs.origin.unknown")}async _saveEdit(){if(this._editing){this._editBusy=!0,this._editError=null;try{const e=await this.api.wigsUpdate(this._editing.filename,{name:this._editName.trim()||this._editing.name,brand:this._editBrand.trim(),model:this._editModel.trim(),kind:this._editKind.trim(),notes:this._editNotes.trim(),fcc_id:this._editFccId.trim(),upc:this._editUpc.trim(),asin:this._editAsin.trim(),oem:this._editOem.trim()});if(!e.success)return void(this._editError=(e.errors??[]).join("; "));this._editing=null,await this._refresh()}catch(e){this._editError=e.message}finally{this._editBusy=!1}}}async _downloadText(e,i){try{const t=new Blob([i],{type:"application/json"}),a=URL.createObjectURL(t),o=document.createElement("a");o.href=a,o.download=e,o.click(),URL.revokeObjectURL(a)}catch{await navigator.clipboard.writeText(i),this._flash(ke("wigs.editor.copied"))}}async _download(e){if(e)try{const{filename:i,text:t}=await this.api.wigsGet(e.filename);await this._downloadText(i,t)}catch(e){this._flash(e.message)}}async _downloadLibrary(e){try{const{filename:i,text:t}=await this.api.wigRender(e.id);await this._downloadText(i,t)}catch(e){this._flash(e.message,"warn")}}async _fitLibrary(e){this._busyId=e.id;try{const i=await this.api.wigSnapshot(e.id);this._flash(ke(i.existed?"wigs.snapshot_existing":"wigs.snapshot_saved",{filename:i.filename})),await this._refresh();const t=this._wigs.find(e=>e.filename===i.filename);t&&(this._fittingWig=t)}catch(e){this._flash(e.message,"warn")}finally{this._busyId=null}}async _confirmDeleteWig(){const e=this._confirmDelete;if(this._confirmDelete=null,e)try{await this.api.wigsDelete(e.filename),this._editing=null,await this._refresh()}catch(e){this._flash(e.message,"warn")}}_counts(){const e=this._library.reduce((e,i)=>e+i.codebooks.filter(e=>"local"!==e.source).length,0),i=this._wigs.length,t=this._wigs.filter(e=>e.fitting?.state).length;return{all:e+i,library:e,yours:i,fitted:t,unfitted:i-t}}render(){if(this._loading)return B`<div class="loading">${ke("common.loading_plain")}</div>`;const e=this._counts(),i=this._brandRows();return B`
            ...
            >
                ...
                <div>
                    ${this._receipt?B`<div class="t1">
                              ...
                              <div class="t2">${this._renderDropTitle()}</div>`:B`<div class="t1">${this._renderDropTitle()}</div>
            ...
            <div class="toolbar">
                ...
                <button
                    class="fchip ${"fitted"===this._filter?"on":""}"
                    @click=${()=>this._filter="fitted"}
                >
                    <span class="chip-tick">&check;</span>
                    ${ke("wigs.chip.fitted",{count:String(e.fitted)})}
                </button>
                <button
                    class="fchip ${"unfitted"===this._filter?"on":""}"
                    @click=${()=>this._filter="unfitted"}
                >
                    ${ke("wigs.chip.unfitted",{count:String(e.unfitted)})}
                </button>
            ...
            ${this._renderEditor()}
            ${this._adoptWig?B`<ir-promote-dialog
                      .api=${this.api}
                      .hass=${this.hass}
                      .suggestedName=${this._adoptWig.name}
                      .suggestedType=${this._typeFromKind(this._adoptWig.kind)}
                  ...
                  ></ir-promote-dialog>`:""}
            ${this._adoptCodebook?B`<ir-promote-dialog
                      .api=${this.api}
                      .hass=${this.hass}
            ...
            ${this._fittingWig?B`<ir-fitting-dialog
                      .api=${this.api}
                      .hass=${this.hass}
                  ...
                  ></ir-fitting-dialog>`:""}
        `}async _onWigAdopted(){const e=this._adoptWig?.name??this._adoptCodebook?.label??"";this._adoptWig=null,this._adoptCodebook=null,this._flash(ke("wigs.adopted",{name:e}),"ok"),await this._refresh()}async _onFittingRecorded(e){const i=e.detail;i&&this._flash("perfect"===i.state?ke("fitting.recorded_perfect"):ke("fitting.recorded_partial",{confirmed:String(i.confirmed),total:String(i.total)}),"ok"),await this._refresh(null!==this._fittingWig)}_renderBrand(e){const i=this._visibleRows(e);if(0===i.length&&this._search.trim())return"";if(0===i.length&&"all"!==this._filter)return"";const t=this._isOpen(e,i),a=e.rows.filter(e=>"library"===e.source).length,o=e.rows.filter(e=>"local"===e.source).length;return B`
            <div
                ...
                >
                    ...
                    <span class="dots">
                        ${a>0?B`<span class="count-chip lib"
                                  >${$e("wigs.count",a)}</span
                              >`:""}
                        ${o>0?B`<span class="count-chip mine"
                                  >${$e("wigs.count",o)}</span
                              >`:""}
                    </span>
                    <ha-svg-icon
        ...
        `}_renderRow(e){return B`
            ...
            >
                ...
                >
                    ${e.wig?.matrix?$e("wigs.states",e.wig.matrix.cells):$e("wigs.signals",e.signalCount)}
                </button>
                ${e.wig?.fitting?.state?B`<span
                          class="fit-tick ${e.wig.fitting.state} ${"perfect"===e.wig.fitting.user_state?"yours":""} ${e.wig.matrix?"matrix":""}"
                          title=${"perfect"===e.wig.fitting.state?ke("wigs.fit_tick.perfect"):ke("wigs.fit_tick.partial",{confirmed:String(e.wig.fitting.confirmed),total:String(e.wig.fitting.total)})}
                          >&check;</span
                      >`:""}
                <span class="row-actions">
                    ...
                    <span class="glyph-slot">
                        <button
                            ...
                            @click=${()=>e.wig?void this._download(e.wig):void this._downloadLibrary(e)}
                        >
                            <ha-svg-icon
                                class="dl-icon"
        ...
        `}_renderEditor(){if(this._confirmDelete)return B`
            ...
            >
                ...
                <div class="field">
                    <label>${ke("wigs.editor.kind")}</label>
                    <input
                        type="text"
                        list="wig-kind-suggestions"
                        placeholder=${ke("wigs.editor.kind_placeholder")}
                        .value=${this._editKind}
                        @input=${e=>this._editKind=e.target.value}
                    />
                    <datalist id="wig-kind-suggestions">
                        ${this._kindSuggestions().map(e=>B`<option value=${e}></option>`)}
                    </datalist>
                    <div class="ident-hint">
                        ${ke("wigs.editor.kind_hint")}
                    </div>
                </div>
                <div class="ident-grid">
                    <div class="field">
                        ...
                        <input
                            ...
                            @input=${e=>this._editFccId=e.target.value}
                        />
                    </div>
                    <div class="field">
                        <label>${ke("wigs.editor.upc")}</label>
                        <input
                            type="text"
                            .value=${this._editUpc}
                            @input=${e=>this._editUpc=e.target.value}
                        />
                    </div>
                    <div class="field">
                        <label>${ke("wigs.editor.asin")}</label>
                        <input
                            ...
                            @input=${e=>this._editAsin=e.target.value}
                        />
                    </div>
                    <div class="field">
                        <label>${ke("wigs.editor.oem")}</label>
                        <input
                            type="text"
                            .value=${this._editOem}
                            @input=${e=>this._editOem=e.target.value}
                        />
                    </div>
                </div>
                <div class="ident-hint">${ke("wigs.editor.ids_hint")}</div>
    ...
    `],e([pe({attribute:!1})],Fa.prototype,"api",void 0),e([pe({attribute:!1})],Fa.prototype,"hass",void 0),e([ge()],Fa.prototype,"_loading",void 0),e([ge()],Fa.prototype,"_error",void 0),e([ge()],Fa.prototype,"_wigs",void 0),e([ge()],Fa.prototype,"_invalid",void 0),e([ge()],Fa.prototype,"_library",void 0),e([ge()],Fa.prototype,"_libraryVersion",void 0),e([ge()],Fa.prototype,"_search",void 0),e([ge()],Fa.prototype,"_filter",void 0),e([ge()],Fa.prototype,"_openBrands",void 0),e([ge()],Fa.prototype,"_dragOver",void 0),e([ge()],Fa.prototype,"_notice",void 0),e([ge()],Fa.prototype,"_noticeKind",void 0),e([ge()],Fa.prototype,"_receipt",void 0),e([ge()],Fa.prototype,"_receiptKind",void 0),e([ge()],Fa.prototype,"_receiptFiles",void 0),e([ge()],Fa.prototype,"_receiptSuffix",void 0),e([ge()],Fa.prototype,"_bloomId",void 0),e([ge()],Fa.prototype,"_busyId",void 0),e([ge()],Fa.prototype,"_fittingWig",void 0),e([ge()],Fa.prototype,"_adoptWig",void 0),e([ge()],Fa.prototype,"_adoptCodebook",void 0),e([ge()],Fa.prototype,"_linkedPopoverId",void 0),e([ge()],Fa.prototype,"_peekId",void 0),e([ge()],Fa.prototype,"_clipConfirm",void 0),e([ge()],Fa.prototype,"_editing",void 0),e([ge()],Fa.prototype,"_editName",void 0),e([ge()],Fa.prototype,"_editBrand",void 0),e([ge()],Fa.prototype,"_editModel",void 0),e([ge()],Fa.prototype,"_editKind",void 0),e([ge()],Fa.prototype,"_editNotes",void 0),e([ge()],Fa.prototype,"_editFccId",void 0),e([ge()],Fa.prototype,"_editUpc",void 0),e([ge()],Fa.prototype,"_editAsin",void 0),e([ge()],Fa.prototype,"_editOem",void 0),e([ge()],Fa.prototype,"_editBusy",void 0),e([ge()],Fa.prototype,"_editError",void 0),e([ge()],Fa.prototype,"_confirmDelete",void 0),Fa=e([ue("ir-wigs")],Fa);let Ua=class extends se{constructor(){super(...arguments),this.narrow=!1,this._activeTab="devices",this._devices=[],this._expandedDeviceId=null,this._loading=!0,this._error=null,this._addDialogOpen=!1,this._pluckersAvailable=!1,this._pendingPluckEntity="",this._api=null}connectedCallback(){super.connectedCallback(),this.hass&&this._init()}updated(e){e.has("hass")&&this.hass&&(function(e){const i=e||"en";if(i!==be){be=i;try{we=new Intl.PluralRules(i)}catch{we=new Intl.PluralRules("en")}}const t=i.toLowerCase();let a="en";if(ve[t])a=t;else{const e=t.split("-")[0];ve[e]&&(a=e)}fe=a}(this.hass.language),this._api||this._init())}_init(){this._api=new he(this.hass),this._refreshDevices(),this._checkPluckers()}async _checkPluckers(){if(this._api){try{const{vendors:e}=await this._api.listPluckVendors();this._pluckersAvailable=e.length>0}catch{this._pluckersAvailable=!1}"plucker"!==this._activeTab||this._pluckersAvailable||this._switchTab("devices")}}_tagline(){return ke(`panel.tagline.${this._activeTab}`)}async _refreshDevices(){if(this._api){this._loading=!0;try{this._devices=await this._api.listDevices(),this._error=null}catch(e){this._error=ke("panel.load_failed",{message:e.message})}finally{this._loading=!1}}}_toggleDevice(e){this._expandedDeviceId=this._expandedDeviceId===e?null:e}_openAddDialog(){this._addDialogOpen=!0}_onNavigatePlucker(e){this._pendingPluckEntity=e.detail?.vendor_entity_id??"",this._switchTab("plucker")}_onNavigateDevice(e){this._switchTab("devices"),this._expandedDeviceId=e.detail}_closeAddDialog(){this._addDialogOpen=!1}async _onDeviceCreated(e){this._addDialogOpen=!1,await this._refreshDevices(),this._expandedDeviceId=e.detail.id}async _onDeviceChanged(){await this._refreshDevices()}async _onDeviceDeleted(){this._expandedDeviceId=null,await this._refreshDevices()}_switchTab(e){this._expandedDeviceId=null,this._activeTab=e,"devices"===e&&this._refreshDevices()}_openHaSidebar(){this.dispatchEvent(new Event("hass-toggle-menu",{bubbles:!0,composed:!0}))}render(){return this._api?B`
        ...
        `:B`<div class="loading">${ke("panel.loading")}</div>`}};Ua.styles=n`
        :host {
            display: block;
            background: var(--primary-background-color);
            color: var(--primary-text-color);
    ...
    `,e([pe({attribute:!1})],Ua.prototype,"hass",void 0),e([pe({attribute:!1})],Ua.prototype,"narrow",void 0),e([pe({attribute:!1})],Ua.prototype,"route",void 0),e([pe({attribute:!1})],Ua.prototype,"panel",void 0),e([ge()],Ua.prototype,"_activeTab",void 0),e([ge()],Ua.prototype,"_devices",void 0),e([ge()],Ua.prototype,"_expandedDeviceId",void 0),e([ge()],Ua.prototype,"_loading",void 0),e([ge()],Ua.prototype,"_error",void 0),e([ge()],Ua.prototype,"_addDialogOpen",void 0),e([ge()],Ua.prototype,"_pluckersAvailable",void 0),e([ge()],Ua.prototype,"_pendingPluckEntity",void 0),Ua=e([ue("ha-panel-ir-devices")],Ua);export{Ua as HaPanelIrDevices};
