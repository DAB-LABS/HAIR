...
`;let Qi=class extends ne{constructor(){super(...arguments),this.triggers=[],this.receivers=[],this.top=0,this.left=0}render(){return F`
            <div
        ...
        `}_renderScope(e){const t=e.receiver_entity_ids??[];return 0===t.length?$e("popover.any_receiver"):1===t.length?this._friendly(t[0]):$e("popover.n_more",{name:this._friendly(t[0]),count:t.length-1})}_friendly(e){const t=this.receivers.find(t=>t.entity_id===e);return t?.name??e}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}};Qi.styles=[Ki,a`
            :host {
                display: contents;
            }
