            ...
            <div class="overlay" @click=${this._close}>
                <div class="dialog" @click=${e=>e.stopPropagation()}>
                    ...
                    <div class="signal-info">
                        ${i?this._renderDiamonds(i):t?j`<span class="proto">${t}</span>`:j`<span class="proto">IR Signal</span>`}
                    </div>
            ...
            ${o?j`
                      ...
                      <div class="grid">
                          ${this._triggers.map(e=>j`
                                  ...
                                  >
                                      <div class="card-header">
                                          <ha-svg-icon .path=${"M7,2V13H10V22L17,10H13L17,2H7Z"}></ha-svg-icon>
        ...
        `}_renderExpanded(e){return j`
            <div class="expanded">
                ...
                <div class="signal-list">
                    ${e.signals.map(t=>{const i=this._recentFingerprints.indexOf(t.fingerprint),s=0===i,a=1===i,r=this._glowFingerprints.has(t.fingerprint),o=this._hitFlashFingerprints.has(t.fingerprint);return j`
                            <div class="signal-row">
                                ...
                                <div class="signal-actions">
                                    <button
                                        class="action-btn assign-btn ${s?"recent-latest":""} ${a?"recent-previous":""} ${r?"glow":""}"
