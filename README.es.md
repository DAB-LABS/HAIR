...
<p align="center">
```
`<img src="images/HAIR-readme-hero-v0.2.png" alt="Cartel de la barbería HAIR Full Service, con la mascota TX dando la bienvenida a la nueva mascota RX en la entrada y un bocadillo RX IS HERE sobre ellas" width="900" />`{=html}
```{=html}
</p>
```
```{=html}
<p align="center">
```
`<a href="README.md">`{=html}English`</a>`{=html} · Español ·
`<a href="README.fr.md">`{=html}Français`</a>`{=html} ·
`<a href="README.ja.md">`{=html}日本語`</a>`{=html} ·
`<a href="README.de.md">`{=html}Deutsch`</a>`{=html} ·
`<a href="README.pl.md">`{=html}Polski`</a>`{=html} ·
`<a href="README.pt.md">`{=html}Português`</a>`{=html} ·
`<a href="README.nl.md">`{=html}Nederlands`</a>`{=html} ·
`<a href="README.it.md">`{=html}Italiano`</a>`{=html} ·
`<a href="README.ru.md">`{=html}Русский`</a>`{=html}
```{=html}
</p>
```
# HAIR
...
> \[!IMPORTANT\] **HAIR habla diez idiomas, y ocho de ellos necesitan tu
...
adoptado:
  ...
  -------------------------------------------------------------------- ----------- ----------- ----------- ----------- -----------
  [ESPHome](https://esphome.io/)                                       Core        Sí          Sí          No          Desde
                                                                                                                       2026.4
                                                                                                                       (TX),
                                                                                                                       2026.6 (RX
                                                                                                                       nativo)

  [Tuya Local](https://github.com/make-all/tuya-local)                 HACS        Sí          No          Sí          TX desde
                                                                                                                       2026.4,
                                                                                                                       Pluck desde
                                                                                                                       2026.6.2

  [Broadlink](https://www.home-assistant.io/integrations/broadlink/)   Core        Sí          No          No          Desde
                                                                                                                       2026.5

  [SMLIGHT](https://www.home-assistant.io/integrations/smlight/)       Core        Sí          Sí          No          TX desde
                                                                                                                       2026.5, RX
                                                                                                                       nativo
                                                                                                                       (Ultima)
                                                                                                                       desde
...
## Capturas de pantalla
  ...
  --------------------------------------------------- ------------------------------------------------
        ![Vista general con dispositivos HAIR,             ![Detalle del dispositivo con comandos
         disparadores, emisores, receptores y         aprendidos, huellas S/L, acciones localizadas y
   proxies](images/screenshots/devices-overview.png)                     botones de
                                                       disparo](images/screenshots/device-detail.png)
  ...
  -----------------------------------------------------------------------
   ![El mismo detalle del dispositivo en japonés, con acciones y botones
   traducidos mientras los nombres Sniffer, Clipper y Mirror permanecen
          sin traducir](images/screenshots/device-detail-ja.png)
...
idioma del perfil. Toda la interfaz de HAIR es multilingüe.
  ...
  -----------------------------------------------------------------------
                                  Mirror
  -----------------------------------------------------------------------
      ![Pestaña Mirror registrando cada envío IR originado en HA, con
               procedencia, zonas que lo oyeron y número de
                envíos](images/screenshots/mirror-tab.png)
  ...
  -----------------------------------------------------------------------
                                 Colección
  -----------------------------------------------------------------------
  ![Pestaña Colección con estantes por marca, contadores y perfiles de la
          biblioteca y personales](images/screenshots/closet.png)
  ...
  ------------------------------------------------------- -----------------------------------------------------
      ![Selector de asignación con opciones de modo y      ![Sniffer mostrando señales capturadas con huellas
                  ventilador y una acción                               S/L, botones de disparo y
   personalizada](images/screenshots/action-mapping.png)   contadores](images/screenshots/sniffer-signals.png)
  ...
  --------------------------------------------------- -----------------------------------------------
     ![Selector que muestra todos los comandos de       ![Selector que muestra las automatizaciones
  dispositivo vinculados a una señal, con navegación  disparadas por una señal y un acceso para crear
   directa](images/screenshots/assigned-popover.png)   otra](images/screenshots/trigger-popover.png)
  ...
  ---------------------------------------------------- ----------------------------------------------------- -----------------------------------------------------
    ![Diálogo para asignar una señal capturada a un     ![Diálogo para crear un disparador con patrón S/L y    ![Diálogo para crear un nuevo dispositivo HAIR a
                       comando de                                            mínimo de                                        partir de un mando
   dispositivo](images/screenshots/assign-dialog.png)   detecciones](images/screenshots/trigger-dialog.png)   desconocido](images/screenshots/promote-dialog.png)
...
<summary>
```
`<b>`{=html}¿Empiezas desde cero? YAML mínimo completo (TX + RX +
registro)`</b>`{=html}
```{=html}
</summary>
```
...
<summary>
```
Puente heredado para HA 2026.4-2026.5 (solo si no puedes actualizar)
```{=html}
</summary>
```
...
su tipo:
  ...
  --------------- ----------------------------- --------------------------
  Reproductor     `media_player`                Encendido, volumen,
  multimedia                                    silencio, fuente, canales,
                                                navegación, transporte

  Aire            `climate`                     Modos HVAC, preajustes de
  acondicionado                                 temperatura o matriz
                                                completa de estados, modos
                                                de ventilador, oscilación

  Ventilador      `fan`                         Encendido, pasos de
                                                velocidad o niveles
                                                directos (1-10),
                                                oscilación

  Luz             `light`                       Encendido/apagado, pasos
                                                de brillo
  ...
  Otro            `remote`                      Emisor genérico de
                                                comandos IR
  ------------------------------------------------------------------------
